...
/* dark magic, please ignore */ try {
  enableProdMode();
} catch (e) {}
/* The code below is used to match the Components with the appropriate templates. */ class MyResourceLoader extends ResourceLoader {
...
export const hmrBootstrap = (ngModule: NgModuleRef<any>) => {
...
if (window['ref']) {
  ...
  window['ref'] = null;
} /*d:bootstrapSolved/trimTrailing*/

/*/d*/ const platform = platformBrowserDynamic(); /*d:bootstrapSolved:bootstrapSolved/trimTrailing*/
/*/d*/ platform.bootstrapModule(AppModule); /*d:templatePageSetup/trimTrailing*/
/*/d*/ platform
