...
export class AppModule {}`;
  ...
  bootstrap(module: SimpleImport = { name: 'AppModule', path: './modules.module' }): string {
...
export function solve(exerciseConfig) {
  return {
    ...exerciseConfig,
    files: exerciseConfig.files.map(file => ({ ...file, code: file.solution || file.code }))
  };
}
