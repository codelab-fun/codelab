...
const debuggerAndConsoleLogAst = removeDoubleWhiteLines(
  processCode(jsify(parseCode(debuggerAndConsoleLog).program.body), { remove: [removeLoc] })
);
...
export class AstComponent {
  ...
  code = {
    ...
    findDebugger: [
      exercise(
        'find-debugger',
        require('!!raw-loader!./samples/find-debugger/find-debugger.js'),
    ...
    traverseDebuggerBabel: [
      exercise(
        'traverse-debugger-babel',
        require('!!raw-loader!./samples/find-debugger/traverse-debugger-babel.ts'),
    ...
    removeDebuggerBabel: [
      exercise(
        'remove-debugger',
        require('!!raw-loader!./samples/find-debugger/remove-debugger.ts'),
