...
export class StructuralDirectivesComponent {
  ...
  code = {
    materialTabs: [
      html(
        'app',
        require('!!raw-loader!./samples/material-tabs/modules.html'),
        require('!!raw-loader!./samples/material-tabs/modules.solved.html')
      ),
      exercise('app.component', require('!!raw-loader!./samples/material-tabs/modules.component.ts')),
      ...
      exercise('app.module', require('!!raw-loader!./samples/material-tabs/modules.module.ts')),
      exercise(
    ...
    materialTabsStructuralDirective: [
      html(
        'app',
        require('!!raw-loader!./samples/material-tabs-structural-directive/modules.html'),
        require('!!raw-loader!./samples/material-tabs-structural-directive/modules.solved.html')
      ),
      exercise(
        'app.component',
        require('!!raw-loader!./samples/material-tabs-structural-directive/modules.component.ts')
      ),
      exercise(
        'hideme.directive',
      ...
      exercise('app.module', require('!!raw-loader!./samples/material-tabs-structural-directive/modules.module.ts')),
      stylesheet(require('!!raw-loader!./samples/material-tabs/style.css')),
      bootstrap('main', builder.bootstrap())
    ],
    microSyntax: [
    ...
    mdTabNavBar: [
      exercise('app.component', require('!!raw-loader!./samples/mat-tab-nav-bar/modules.component.ts')),
      ...
      stylesheet(require('!!raw-loader!./samples/material-tabs/style.css')),
      exercise('app.module', require('!!raw-loader!./samples/mat-tab-nav-bar/modules.module.ts')),
      bootstrap('main', builder.bootstrap())
    ],
