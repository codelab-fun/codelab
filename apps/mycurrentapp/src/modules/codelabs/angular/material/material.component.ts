...
function matExercise(modules, html, highlights: FileHighlights = {}, theme = 'purple') {
  const moduleCode = require('!!raw-loader!./samples/basic/modules.module.ts').replace(/MatToolbarModule/g, modules);
  ...
  return {
    files: [
      ...
      CodelabFile.TypeScriptFile('app.component').setCode(require('!!raw-loader!./samples/basic/modules.component.ts')),
...
export class MaterialComponent {
  ...
  code = {
    material: {
      step1: matExercise(`MatToolbarModule`, require('!!raw-loader!./samples/basic/modules.1.html'), {
        appModule: /MatToolbarModule(?:\n)/,
        appHtml: /<mat-toolbar[\s\S]*<\/mat-toolbar>/
      }),
      step2: matExercise(
        `MatToolbarModule,\n    MatCardModule`,
        require('!!raw-loader!./samples/basic/modules.2.html'),
        {
      ...
      step3: matExercise(
        `MatToolbarModule,\n    MatCardModule`,
        require('!!raw-loader!./samples/basic/modules.3.html'),
        {
      ...
      step4: matExercise(
        `MatToolbarModule,\n    MatCardModule,\n    MatButtonModule`,
        require('!!raw-loader!./samples/basic/modules.4.html'),
        {
