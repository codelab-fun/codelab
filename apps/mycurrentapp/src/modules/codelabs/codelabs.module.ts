...
export let routes = [
  ...
  },
  {
    ...
    name: 'Component-Tree',
    description: 'Learn how to structure your modules with reusable components',
    page: 'main',
    prod: true,
  ...
  },
  {
    ...
    name: 'Forms',
    description: '[🚧 Work In Progress] Learn how to add Forms to your modules',
    page: 'main',
    prod: true
  },
  {
