...
describe('Utils', () => {
  describe('findPosition', () => {
    ...
    it('Part of the string matched', () => {
      expect(findPosition('YoHello', 'Hello')).toEqual({lineStart: 1, indexStart: 3, indexEnd: 8, lineEnd: 1});
    });

    it('Multiline beginning of the line', () => {
      expect(findPosition(`Yo uuuu
Hello`, 'Hello')).toEqual({lineStart: 2, indexStart: 1, indexEnd: 6, lineEnd: 2});
    });
    it('Multiline:2 lines', () => {
      expect(findPosition(`Yo uuuu

Hello`, 'Hello')).toEqual({lineStart: 3, indexStart: 1, indexEnd: 6, lineEnd: 3});
    });
    it('Multiline with text in beginning', () => {
      expect(findPosition(`Yo uuuu
123Hello`, 'Hello')).toEqual({lineStart: 2, indexStart: 4, indexEnd: 9, lineEnd: 2});
    });
