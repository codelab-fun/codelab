(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global =
      ...
      factory((global.ngCommon = {}), global.ng));
  ...
  LocationStrategy.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    ...
    type: LocationStrategy,
    providedIn: 'root',
    useFactory: () => i0.inject(PathLocationStrategy),
  });
  i0__namespace.ɵɵngDeclareClassMetadata({
    minVersion: '12.0.0',
    version: '14.2.7',
  ...
  class PathLocationStrategy extends LocationStrategy {
        ...
        (_c =
          (_a =
            href !== null && href !== void 0
              ? href
              : this._platformLocation.getBaseHrefFromDOM()) !== null &&
          _a !== void 0
            ? _a
            : (_b = i0.inject(DOCUMENT).location) === null || _b === void 0
            ? void 0
    ...
    historyGo(relativePosition = 0) {
      var _a, _b;
      (_b = (_a = this._platformLocation).historyGo) === null || _b === void 0
        ? void 0
        : _b.call(_a, relativePosition);
    }
  }
  ...
  class Location {
    ...
    ngOnDestroy() {
      var _a;
      (_a = this._urlChangeSubscription) === null || _a === void 0
        ? void 0
        : _a.unsubscribe();
      this._urlChangeListeners = [];
    }
    ...
    historyGo(relativePosition = 0) {
      var _a, _b;
      (_b = (_a = this._locationStrategy).historyGo) === null || _b === void 0
        ? void 0
        : _b.call(_a, relativePosition);
    }
    /**
  ...
  function getLocaleNumberSymbol(locale, symbol) {
    ...
    if (typeof res === 'undefined') {
      if (symbol === exports.NumberSymbol.CurrencyDecimal) {
        return data[i0['ɵLocaleDataIndex'].NumberSymbols][
          exports.NumberSymbol.Decimal
        ];
      } else if (symbol === exports.NumberSymbol.CurrencyGroup) {
        return data[i0['ɵLocaleDataIndex'].NumberSymbols][
          exports.NumberSymbol.Group
        ];
      }
    }
    return res;
    ...
    if (!data[i0['ɵLocaleDataIndex'].ExtraData]) {
      throw new Error(
        `Missing extra locale data for the locale "${
          data[i0['ɵLocaleDataIndex'].LocaleId]
  ...
  function getLocaleExtraDayPeriodRules(locale) {
    ...
    const rules =
      data[
        i0['ɵLocaleDataIndex'].ExtraData
      ][2 /* ɵExtraLocaleDataIndex.ExtraDayPeriodsRules */] || [];
  ...
  function getLocaleExtraDayPeriods(locale, formStyle, width) {
    ...
    const dayPeriodsData = [
      data[
        i0['ɵLocaleDataIndex'].ExtraData
      ][0 /* ɵExtraLocaleDataIndex.ExtraDayPeriodFormats */],
      data[
        i0['ɵLocaleDataIndex'].ExtraData
      ][1 /* ɵExtraLocaleDataIndex.ExtraDayPeriodStandalone */],
    ];
    ...
    switch (format) {
      ...
      case 'short':
        ...
        formatValue = formatDateTime(
          getLocaleDateTimeFormat(locale, exports.FormatWidth.Short),
          [shortTime, shortDate]
        );
        break;
      case 'medium':
        ...
        formatValue = formatDateTime(
          getLocaleDateTimeFormat(locale, exports.FormatWidth.Medium),
      ...
      case 'long':
        ...
        formatValue = formatDateTime(
          getLocaleDateTimeFormat(locale, exports.FormatWidth.Long),
          [longTime, longDate]
        );
        break;
      case 'full':
        ...
        formatValue = formatDateTime(
          getLocaleDateTimeFormat(locale, exports.FormatWidth.Full),
          [fullTime, fullDate]
        );
        break;
    }
  ...
  function dateGetter(name, size, offset = 0, trim = false, negWrap = false) {
    return function (date, locale) {
      ...
      const localeMinus = getLocaleNumberSymbol(
        locale,
        exports.NumberSymbol.MinusSign
      );
  ...
  function timeZoneGetter(width) {
    return function (date, locale, offset) {
      const zone = -1 * offset;
      const minusSign = getLocaleNumberSymbol(
        locale,
        exports.NumberSymbol.MinusSign
      );
  ...
  function weekGetter(size, monthBased = false) {
    return function (date, locale) {
      ...
      return padNumber(
        result,
        size,
        getLocaleNumberSymbol(locale, exports.NumberSymbol.MinusSign)
      );
    };
  }
  /**
    ...
    switch (format) {
      ...
      case 'GGG':
        formatter = dateStrGetter(
          ...
          exports.TranslationWidth.Abbreviated
        );
        break;
      case 'GGGG':
        formatter = dateStrGetter(
          TranslationType.Eras,
          exports.TranslationWidth.Wide
        );
        break;
      case 'GGGGG':
        formatter = dateStrGetter(
          TranslationType.Eras,
          exports.TranslationWidth.Narrow
        );
        break;
      ...
      case 'cccccc':
        formatter = dateStrGetter(
          TranslationType.Days,
          exports.TranslationWidth.Short,
          exports.FormStyle.Standalone
        );
        break;
      // Day of the Week
  ...
  function formatNumberToLocaleString(
    ...
    if (!isFinite(value)) {
      ...
      if (exponent) {
        formattedText +=
          getLocaleNumberSymbol(locale, exports.NumberSymbol.Exponential) +
          '+' +
          exponent;
      }
    }
  ...
  function formatCurrency(value, locale, currency, currencyCode, digitsInfo) {
    const format = getLocaleNumberFormat(
      locale,
      exports.NumberFormatStyle.Currency
    );
    ...
    const res = formatNumberToLocaleString(
      ...
      pattern,
      locale,
      exports.NumberSymbol.CurrencyGroup,
      exports.NumberSymbol.CurrencyDecimal,
      digitsInfo
    );
    return (
      res
  ...
  function formatPercent(value, locale, digitsInfo) {
    const format = getLocaleNumberFormat(
      locale,
      exports.NumberFormatStyle.Percent
    );
    const pattern = parseNumberFormat(
      format,
      getLocaleNumberSymbol(locale, exports.NumberSymbol.MinusSign)
    ...
    return res.replace(
      ...
      getLocaleNumberSymbol(locale, exports.NumberSymbol.PercentSign)
    );
  }
  /**
   * @ngModule CommonModule
  ...
  function formatNumber(value, locale, digitsInfo) {
    const format = getLocaleNumberFormat(
      locale,
      exports.NumberFormatStyle.Decimal
    );
    const pattern = parseNumberFormat(
      format,
      getLocaleNumberSymbol(locale, exports.NumberSymbol.MinusSign)
    ...
    _applyIterableChanges(changes) {
      changes.forEachAddedItem((record) => {
        if (typeof record.item === 'string') {
          ...
          throw new Error(
            `NgClass can only toggle CSS classes expressed as strings, got ${i0[
              'ɵstringify'
            ](record.item)}`
          );
        }
  ...
  NgClass.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    ...
    type: NgClass,
    deps: [
      { token: i0__namespace.IterableDiffers },
      { token: i0__namespace.KeyValueDiffers },
  ...
  i0__namespace.ɵɵngDeclareClassMetadata({
    ...
    ctorParameters: function () {
      return [
        { type: i0__namespace.IterableDiffers },
        { type: i0__namespace.KeyValueDiffers },
  ...
  class NgComponentOutlet {
    ...
    ngOnChanges(changes) {
      ...
      if (this.ngComponentOutlet) {
        const injector =
          this.ngComponentOutletInjector || viewContainerRef.parentInjector;
        if (
          changes['ngComponentOutletNgModule'] ||
          changes['ngComponentOutletNgModuleFactory']
        ) {
          if (this._moduleRef) this._moduleRef.destroy();
          if (ngModule) {
            this._moduleRef = i0.createNgModule(
              ngModule,
              getParentInjector(injector)
            );
          } else if (ngModuleFactory) {
            this._moduleRef = ngModuleFactory.create(
              getParentInjector(injector)
            );
          } else {
        ...
        this._componentRef = viewContainerRef.createComponent(
  ...
  i0__namespace.ɵɵngDeclareClassMetadata({
    ...
    ctorParameters: function () {
      return [{ type: i0__namespace.ViewContainerRef }];
    },
    propDecorators: {
      ngComponentOutlet: [
        {
  ...
  NgForOf.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    ...
    type: NgForOf,
    deps: [
      { token: i0__namespace.ViewContainerRef },
      { token: i0__namespace.TemplateRef },
      { token: i0__namespace.IterableDiffers },
    ],
    target: i0__namespace.ɵɵFactoryTarget.Directive,
  });
  ...
  function assertTemplate(property, templateRef) {
    ...
    if (!isTemplateRefOrNull) {
      throw new Error(
        `${property} must be a TemplateRef, but received '${i0['ɵstringify'](
          templateRef
        )}'.`
      );
    }
  ...
  NgSwitchCase.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    ...
    deps: [
      { token: i0__namespace.ViewContainerRef },
      { token: i0__namespace.TemplateRef },
      { token: NgSwitch, host: true, optional: true },
    ],
    target: i0__namespace.ɵɵFactoryTarget.Directive,
  });
  ...
  function throwNgSwitchProviderNotFoundError(attrName, directiveName) {
    throw new i0[
      'ɵRuntimeError'
    ](2000 /* RuntimeErrorCode.PARENT_NG_SWITCH_NOT_FOUND */, `An element with the "${attrName}" attribute ` + `(matching the "${directiveName}" directive) must be located inside an element with the "ngSwitch" attribute ` + `(matching "NgSwitch" directive)`);
  }
  ...
  NgPluralCase.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    ...
    type: NgPluralCase,
    deps: [
      { token: 'ngPluralCase', attribute: true },
      { token: i0__namespace.TemplateRef },
      { token: i0__namespace.ViewContainerRef },
      { token: NgPlural, host: true },
    ],
    target: i0__namespace.ɵɵFactoryTarget.Directive,
  });
  ...
  class NgStyle {
    ...
    _setStyle(nameAndUnit, value) {
      ...
      const flags =
        name.indexOf('-') === -1 ? undefined : i0.RendererStyleFlags2.DashCase;
      if (value != null) {
  ...
  function invalidPipeArgumentError(type, value) {
    return new i0[
      'ɵRuntimeError'
    ](2100 /* RuntimeErrorCode.INVALID_PIPE_ARGUMENT */, ngDevMode && `InvalidPipeArgument: '${value}' for pipe '${i0['ɵstringify'](type)}'`);
  }
  ...
  i0__namespace.ɵɵngDeclareClassMetadata({
    ...
    ctorParameters: function () {
      return [{ type: i0__namespace.ChangeDetectorRef }];
    },
  });
  ...
  i0__namespace.ɵɵngDeclareClassMetadata({
    ...
    ctorParameters: function () {
      return [{ type: i0__namespace.KeyValueDiffers }];
    },
  });
  ...
  ViewportScroller.ɵprov = i0['ɵɵdefineInjectable']({
    ...
    providedIn: 'root',
    factory: () =>
      new BrowserViewportScroller(i0['ɵɵinject'](DOCUMENT), window),
  });
  /**
  ...
  function throwInvalidPathError(path, exampleUrls) {
    throw new i0[
      'ɵRuntimeError'
    ](2959 /* RuntimeErrorCode.INVALID_LOADER_ARGUMENTS */, ngDevMode && `Image loader has detected an invalid path (\`${path}\`). ` + `To fix this, supply a path using one of the following formats: ${exampleUrls.join(' or ')}`);
  }
  ...
  class LCPImageObserver {
    ...
    initPerformanceObserver() {
      const observer = new PerformanceObserver((entryList) => {
        ...
        const imgSrc =
          (_b =
            (_a = lcpElement.element) === null || _a === void 0
              ? void 0
              : _a.src) !== null && _b !== void 0
            ? _b
            : '';
  ...
  function assertNoConflictingSrc(dir) {
    if (dir.src) {
      throw new i0['ɵRuntimeError'](
        ...
        `${imgDirectiveDetails(
          dir.ngSrc
        )} both \`src\` and \`ngSrc\` have been set. ` +
  ...
  function assertNoConflictingSrcset(dir) {
    if (dir.srcset) {
      throw new i0['ɵRuntimeError'](
        ...
        `${imgDirectiveDetails(
          dir.ngSrc
        )} both \`srcset\` and \`ngSrcset\` have been set. ` +
          `Supplying both of these attributes breaks lazy loading. ` +
    ...
    if (ngSrc.startsWith('data:')) {
      ...
      throw new i0['ɵRuntimeError'](
        ...
        `${imgDirectiveDetails(
          dir.ngSrc,
          false
        )} \`ngSrc\` is a Base64-encoded string ` +
  ...
  function assertNotBlobUrl(dir) {
    ...
    if (ngSrc.startsWith('blob:')) {
      throw new i0['ɵRuntimeError'](
        ...
        `${imgDirectiveDetails(
          dir.ngSrc
        )} \`ngSrc\` was set to a blob URL (${ngSrc}). ` +
  ...
  function assertValidNgSrcset(dir, value) {
    ...
    if (!isValidSrcset) {
      throw new i0['ɵRuntimeError'](
        ...
        `${imgDirectiveDetails(
          dir.ngSrc
        )} \`ngSrcset\` has an invalid value (\`${value}\`). ` +
  ...
  function assertUnderDensityCap(dir, value) {
    ...
    if (!underDensityCap) {
      throw new i0['ɵRuntimeError'](
        ...
        `${imgDirectiveDetails(
          dir.ngSrc
        )} the \`ngSrcset\` contains an unsupported image density:` +
  ...
  function assertGreaterThanZero(dir, inputValue, inputName) {
    ...
    if (!validNumber && !validString) {
      throw new i0['ɵRuntimeError'](
        ...
        `${imgDirectiveDetails(
          dir.ngSrc
        )} \`${inputName}\` has an invalid value ` +
        ...
        if (oversizedWidth || oversizedHeight) {
          console.warn(
            i0['ɵformatRuntimeError'](
              ...
              `${imgDirectiveDetails(
                dir.ngSrc
              )} the intrinsic image is significantly ` +
