(function (global, factory) {
  ...
  (function (TagContentType) {
    ...
    TagContentType[(TagContentType['ESCAPABLE_RAW_TEXT'] = 1)] =
      'ESCAPABLE_RAW_TEXT';
  ...
  function splitNsName(elementName) {
    ...
    return [
      elementName.slice(1, colonIndex),
      elementName.slice(colonIndex + 1),
    ];
  }
  ...
  class HtmlTagDefinition {
    constructor({
      ...
      contentType = exports.TagContentType.PARSABLE_DATA,
    ...
    getContentType(prefix) {
      if (typeof this.contentType === 'object') {
        ...
        return overrideType !== null && overrideType !== void 0
          ? overrideType
  ...
  function getHtmlTagDefinition(tagName) {
    ...
    if (!TAG_DEFINITIONS) {
      ...
      TAG_DEFINITIONS = {
        ...
        style: new HtmlTagDefinition({
          contentType: exports.TagContentType.RAW_TEXT,
        }),
    ...
    return (_b =
      (_a = TAG_DEFINITIONS[tagName]) !== null && _a !== void 0
        ? _a
        : TAG_DEFINITIONS[tagName.toLowerCase()]) !== null && _b !== void 0
      ? _b
  ...
  class CssSelector {
      ...
      while ((match = _SELECTOR_REGEXP.exec(selector))) {
        ...
        if (attribute) {
          current.addAttribute(
            ...
            match[6 /* SelectorRegexp.ATTRIBUTE_VALUE */]
          );
        }
    ...
    toString() {
      ...
      this.notSelectors.forEach(
        (notSelector) => (res += `:not(${notSelector})`)
      );
      return res;
    }
  }
  ...
  (function (MissingTranslationStrategy) {
    MissingTranslationStrategy[(MissingTranslationStrategy['Error'] = 0)] =
      'Error';
    MissingTranslationStrategy[(MissingTranslationStrategy['Warning'] = 1)] =
      'Warning';
    MissingTranslationStrategy[(MissingTranslationStrategy['Ignore'] = 2)] =
      'Ignore';
  ...
  var core = /*#__PURE__*/ Object.freeze({
    ...
    get ViewEncapsulation() {
      return exports.ViewEncapsulation;
    },
    get ChangeDetectionStrategy() {
      return exports.ChangeDetectionStrategy;
    },
  ...
  function computeDigest(message) {
    return sha1(
      serializeNodes(message.nodes).join('') + `[${message.meaning}]`
    );
  }
  /**
  ...
  class _SerializerIgnoreIcuExpVisitor extends _SerializerVisitor {
    visitIcu(icu, context) {
      let strCases = Object.keys(icu.cases).map(
        (k) => `${k} {${icu.cases[k].visit(this)}}`
      );
  ...
  function words32ToByteString(words32) {
    return words32.reduce(
      (bytes, word) => bytes.concat(word32ToByteString(word)),
      []
    );
  }
  ...
  (function (BinaryOperator) {
    ...
    BinaryOperator[(BinaryOperator['NullishCoalesce'] = 16)] =
      'NullishCoalesce';
  ...
  class TemplateLiteralElement {
    constructor(text, sourceSpan, rawText) {
      ...
      this.rawText =
        (_a =
          rawText !== null && rawText !== void 0
            ? rawText
            : sourceSpan === null || sourceSpan === void 0
            ? void 0
            : sourceSpan.toString()) !== null && _a !== void 0
          ? _a
  ...
  class LocalizedString extends Expression {
    ...
    getMessagePartSourceSpan(i) {
      var _a, _b;
      return (_b =
        (_a = this.messageParts[i]) === null || _a === void 0
          ? void 0
          : _a.sourceSpan) !== null && _b !== void 0
        ? _b
        : this.sourceSpan;
    }
    getPlaceholderSourceSpan(i) {
      ...
      return (_d =
        (_b =
          (_a = this.placeHolderNames[i]) === null || _a === void 0
            ? void 0
            : _a.sourceSpan) !== null && _b !== void 0
          ? _b
          : (_c = this.expressions[i]) === null || _c === void 0
          ? void 0
          : _c.sourceSpan) !== null && _d !== void 0
        ? _d
        : this.sourceSpan;
    }
    /**
    ...
    serializeI18nTemplatePart(partIndex) {
      ...
      if (
        ((_a = placeholder.associatedMessage) === null || _a === void 0
          ? void 0
          : _a.legacyIds.length) === 0
      ) {
        metaBlock += `${ID_SEPARATOR$1}${computeMsgId(
  ...
  class LiteralArrayExpr extends Expression {
    ...
    isEquivalent(e) {
      return (
        ...
        areAllEquivalent(this.entries, e.entries)
      );
    }
    visitExpression(visitor, context) {
  ...
  class Statement {
    constructor(
      modifiers = exports.StmtModifier.None,
      sourceSpan = null,
      leadingComments
    ) {
      this.modifiers = modifiers;
    ...
    addLeadingComment(leadingComment) {
      ...
      this.leadingComments =
        (_a = this.leadingComments) !== null && _a !== void 0 ? _a : [];
  ...
  var output_ast = /*#__PURE__*/ Object.freeze({
    __proto__: null,
    get TypeModifier() {
      return exports.TypeModifier;
    },
    Type: Type,
    get BuiltinTypeName() {
      return exports.BuiltinTypeName;
    },
    ...
    NONE_TYPE: NONE_TYPE,
    get UnaryOperator() {
      return exports.UnaryOperator;
    },
    get BinaryOperator() {
      return exports.BinaryOperator;
    },
  ...
  class FixupExpression extends Expression {
    ...
    isEquivalent(e) {
      return (
        e instanceof FixupExpression && this.resolved.isEquivalent(e.resolved)
      );
    }
    isConstant() {
      return true;
  ...
  class ConstantPool {
    ...
    getConstLiteral(literal, forceShared) {
      if (
        (literal instanceof LiteralExpr && !isLongStringLiteral(literal)) ||
      ...
      if ((!newValue && !fixup.shared) || (newValue && forceShared)) {
        ...
        this.statements.push(
          definition.toDeclStmt(INFERRED_TYPE, exports.StmtModifier.Final)
        );
        fixup.fixup(usage);
      }
      return fixup;
    ...
    getLiteralFactory(literal) {
      ...
      if (literal instanceof LiteralArrayExpr) {
        const argumentsForKey = literal.entries.map((e) =>
          e.isConstant() ? e : UNKNOWN_VALUE_KEY
        );
        const key = this.keyOf(literalArr(argumentsForKey));
        return this._getLiteralFactory(key, literal.entries, (entries) =>
          literalArr(entries)
        );
      } else {
    ...
    _getLiteralFactory(key, values, resultMap) {
      ...
      if (!literalFactory) {
        const resultExpressions = values.map((e, index) =>
          e.isConstant() ? this.getConstLiteral(e, true) : variable(`a${index}`)
        );
        const parameters = resultExpressions
          .filter(isVariable)
          .map((e) => new FnParam(e.name, DYNAMIC_TYPE));
        const pureFunctionDeclaration = fn(
          parameters,
          [new ReturnStatement(resultMap(resultExpressions))],
          INFERRED_TYPE
        );
        const name = this.freshName();
        this.statements.push(
  ...
  class KeyVisitor {
    ...
    visitLiteralArrayExpr(ast, context) {
      return `[${ast.entries
        .map((entry) => entry.visitExpression(this, context))
        .join(',')}]`;
    }
    visitLiteralMapExpr(ast, context) {
      const mapKey = (entry) => {
          ...
          .map((segment) => {
            ...
            if (segment.sourceUrl != null) {
              ...
              segAsStr += toBase64VLQ(
                sourcesIndex.get(segment.sourceUrl) - lastSourceIndex
              );
  ...
  function toBase64String(value) {
    ...
    for (let i = 0; i < encoded.length; ) {
      ...
      b64 +=
        i2 === null
          ? '='
          : toBase64Digit(((i2 & 15) << 2) | (i3 === null ? 0 : i3 >> 6));
  ...
  class EmitterVisitorContext {
    ...
    lineLength() {
      return (
        this._currentLine.indent * _INDENT_WITH.length +
        this._currentLine.partsLength
      );
    }
    ...
    toSource() {
      return this.sourceLines
        .map((l) =>
          l.parts.length > 0 ? _createIndent(l.indent) + l.parts.join('') : ''
        )
        .join('\n');
    }
      ...
      this.sourceLines.forEach((line, lineIdx) => {
        ...
        while (spanIdx < spans.length) {
          ...
          while (
            ...
            (span === spans[spanIdx] || !spans[spanIdx])
          ) {
            col0 += parts[spanIdx].length;
            spanIdx++;
          }
    ...
    spanOf(line, column) {
      ...
      if (emittedLine) {
        ...
        for (
          let partIndex = 0;
          partIndex < emittedLine.parts.length;
          partIndex++
        ) {
    ...
    get sourceLines() {
      if (
        this._lines.length &&
        this._lines[this._lines.length - 1].parts.length === 0
      ) {
  ...
  function compileFactoryFunction(meta) {
    ...
    if (retExpr === null) {
      ...
      const getInheritedFactoryCall = importExpr(
        Identifiers.getInheritedFactory
  ...
  function createFactoryType(meta) {
    ...
    return expressionType(
      importExpr(Identifiers.FactoryDeclaration, [
  ...
  function compileInjectDependency(dep, target, index) {
    ...
    if (dep.token === null) {
      ...
      const flags =
        ...
        (target === exports.FactoryTarget.Pipe
          ? 16 /* InjectFlags.ForPipe */
          : 0);
      // If this dependency is optional or otherwise has non-default flags, then additional
      // parameters describing how to inject the dependency must be passed to the inject function
      // that's being used.
      let flagsParam =
        flags !== 0 /* InjectFlags.Default */ || dep.optional
          ? literal(flags)
          : null;
  ...
  class BoundEvent {
    ...
    static fromParsedEvent(event) {
      const target =
        event.type === 0 /* ParsedEventType.Regular */
          ? event.targetOrPhase
          : null;
      const phase =
        event.type === 1 /* ParsedEventType.Animation */
          ? event.targetOrPhase
          : null;
  ...
  class CloneVisitor {
    ...
    visitIcu(icu, context) {
      const cases = {};
      Object.keys(icu.cases).forEach(
        (key) => (cases[key] = icu.cases[key].visit(this, context))
      );
  ...
  class LocalizeMessageStringVisitor {
    ...
    visitIcu(icu) {
      ...
      return `{${
        icu.expressionPlaceholder
      }, ${icu.type}, ${strCases.join(' ')}}`;
    }
...
<!ELEMENT ex (#PCDATA)>`;
    ...
    write(messages, locale) {
      ...
      messages.forEach((message) => {
        ...
        rootNode.children.push(
          new CR(2),
          new Tag(_MESSAGE_TAG, attrs, [
            ...sourceTags,
            ...visitor.serialize(message.nodes),
          ])
        );
      });
  ...
  class _Visitor$1 {
    ...
    visitIcu(icu, context) {
      const nodes = [
        new Text$1(`{${icu.expressionPlaceholder}, ${icu.type}, `),
      ];
      Object.keys(icu.cases).forEach((c) => {
        nodes.push(
          new Text$1(`${c} {`),
          ...icu.cases[c].visit(this),
          new Text$1(`} `)
        );
      });
    ...
    visitPlaceholder(ph, context) {
      ...
      return [
        // TC requires PH to have a non empty EX, and uses the text node to show the "original" value.
        new Tag(_PLACEHOLDER_TAG$3, { name: ph.name }, [
          exTag,
          interpolationAsText,
        ]),
      ];
    ...
    visitIcuPlaceholder(ph, context) {
      ...
      const icuCases = Object.keys(ph.value.cases)
        .map((value) => value + ' {...}')
        .join(' ');
      const icuAsText = new Text$1(
        `{${icuExpression}, ${icuType}, ${icuCases}}`
      );
  ...
  function assembleI18nBoundString(
    strings,
    bindingStartIndex = 0,
    contextId = 0
  ) {
    ...
    for (let i = 0; i < lastIdx; i++) {
      acc += `${strings[i]}${wrapI18nPlaceholder(
        bindingStartIndex + i,
        contextId
      )}`;
    }
  ...
  function assembleBoundTextPlaceholders(
    meta,
    bindingStartIndex = 0,
    contextId = 0
  ) {
    ...
    const node =
      meta instanceof Message
        ? meta.nodes.find((node) => node instanceof Container)
        : meta;
    if (node) {
      node.children
  ...
  function formatI18nPlaceholderNamesInMap(params = {}, useCamelCase) {
    ...
    if (params && Object.keys(params).length) {
      Object.keys(params).forEach(
        (key) =>
          (_params[formatI18nPlaceholderName(key, useCamelCase)] = params[key])
      );
    }
    return _params;
  }
  ...
  function temporaryAllocator(statements, name) {
    ...
    return () => {
      if (!temp) {
        statements.push(
          new DeclareVarStmt(TEMPORARY_NAME, undefined, DYNAMIC_TYPE)
        );
        temp = variable(name);
      }
      return temp;
    ...
    return literalMap(
      Object.getOwnPropertyNames(map).map((key) => {
        ...
        return {
          ...
          value:
            keepDeclared && needsDeclaredName
  ...
  function getQueryPredicate(query, constantPool) {
    if (Array.isArray(query.predicate)) {
      ...
      switch (query.predicate.forwardRef) {
        ...
        case 1 /* ForwardRefHandling.Wrapped */:
          return importExpr(Identifiers.resolveForwardRef).callFn([
  ...
  function getInstructionStatements(instructions) {
    ...
    for (const current of instructions) {
      const resolvedParams =
        (_a =
          typeof current.paramsOrFn === 'function'
            ? current.paramsOrFn()
            : current.paramsOrFn) !== null && _a !== void 0
          ? _a
          : [];
      const params = Array.isArray(resolvedParams)
        ? resolvedParams
        : [resolvedParams];
      ...
      if (
        ...
        pendingExpression = pendingExpression.callFn(
          params,
          pendingExpression.sourceSpan
        );
        chainLength++;
      } else {
        ...
        pendingExpression = invokeInstruction(
          current.span,
          current.reference,
          params
        );
  ...
  function compileInjectable(meta, resolveForwardRefs) {
    ...
    if (meta.useClass !== undefined) {
      ...
      if (deps !== undefined) {
        ...
        result = compileFactoryFunction(
          Object.assign(Object.assign({}, factoryMeta), {
      ...
      result = compileFactoryFunction(
        Object.assign(Object.assign({}, factoryMeta), {
          expression: importExpr(Identifiers.inject).callFn([
            meta.useExisting.expression,
          ]),
        })
      );
    } else {
    ...
    const expression = importExpr(Identifiers.ɵɵdefineInjectable).callFn(
      [injectableProps.toLiteralMap()],
      undefined,
      true
    );
    return {
  ...
  function createInjectableType(meta) {
    return new ExpressionType(
      importExpr(Identifiers.InjectableDeclaration, [
        typeWithParameters(meta.type.type, meta.typeArgumentCount),
      ])
    );
  }
  ...
  function createFactoryFunction(type) {
    return fn(
      [new FnParam('t', DYNAMIC_TYPE)],
      [new ReturnStatement(type.prop('ɵfac').callFn([variable('t')]))]
    );
  }
  ...
  class ParseError {
    ...
    contextualMessage() {
      ...
      return ctx
        ? `${this.msg} ("${ctx.before}[${
            exports.ParseErrorLevel[this.level]
          } ->]${ctx.after}")`
        : this.msg;
    }
    toString() {
  ...
  class AbstractJsEmitterVisitor extends AbstractEmitterVisitor {
    ...
    visitLocalizedString(ast, ctx) {
      ...
      ctx.print(
        ast,
        `[${parts
          .map((part) => escapeIdentifier(part.raw, false))
          .join(', ')}])`
      );
  ...
  class JitEvaluator {
    ...
    evaluateCode(sourceUrl, ctx, vars, createSourceMap) {
      ...
      if (createSourceMap) {
        ...
        const emptyFn = newTrustedFunctionForJIT(
          ...fnArgNames.concat('return null;')
        ).toString();
        const headerLines =
          emptyFn.slice(0, emptyFn.indexOf('return null;')).split('\n').length -
          1;
        fnBody += `\n${ctx
          .toSourceMapGenerator(sourceUrl, headerLines)
          .toJsComment()}`;
      }
      ...
      const stmt = new ReturnStatement(
        new LiteralMapExpr(
          this._evalExportedVars.map(
            (resultVar) =>
              new LiteralMapEntry(resultVar, variable(resultVar), false)
          )
        )
      );
  ...
  function compileInjector(meta) {
    ...
    const expression = importExpr(Identifiers.defineInjector).callFn(
  ...
  function createInjectorType(meta) {
    return new ExpressionType(
      importExpr(Identifiers.InjectorDeclaration, [
        new ExpressionType(meta.type.type),
      ])
    );
  }
  ...
  class R3JitReflector {
    ...
    resolveExternalReference(ref) {
      ...
      if (!this.context.hasOwnProperty(ref.name)) {
        throw new Error(
          `No value provided for @angular/core symbol '${ref.name}'.`
        );
      }
  ...
  function compileNgModule(meta) {
    ...
    if (bootstrap.length > 0) {
      definitionMap.set(
        'bootstrap',
        refsToArray(bootstrap, containsForwardDecls)
      );
    }
    if (selectorScopeMode === exports.R3SelectorScopeMode.Inline) {
      ...
      if (declarations.length > 0) {
        definitionMap.set(
          'declarations',
          refsToArray(declarations, containsForwardDecls)
        );
      }
      if (imports.length > 0) {
        definitionMap.set(
          'imports',
          refsToArray(imports, containsForwardDecls)
        );
      }
      if (exports$1.length > 0) {
        definitionMap.set(
          'exports',
          refsToArray(exports$1, containsForwardDecls)
        );
      }
    ...
    const expression = importExpr(Identifiers.defineNgModule).callFn(
      [definitionMap.toLiteralMap()],
      undefined,
      true
    );
  ...
  function compileNgModuleDeclarationExpression(meta) {
    ...
    return importExpr(Identifiers.defineNgModule).callFn([
      definitionMap.toLiteralMap(),
    ]);
  }
  function createNgModuleType({
    ...
    return new ExpressionType(
      importExpr(Identifiers.NgModuleDeclaration, [
  ...
  function tupleOfTypes(types) {
    ...
    return types.length > 0
      ? expressionType(literalArr(typeofTypes))
      : NONE_TYPE;
  }
  ...
  function compilePipeFromMetadata(metadata) {
    ...
    const expression = importExpr(Identifiers.definePipe).callFn(
      [literalMap(definitionMapValues)],
      undefined,
      true
    );
  ...
  function createPipeType(metadata) {
    return new ExpressionType(
      importExpr(Identifiers.PipeDeclaration, [
  ...
  (function (R3TemplateDependencyKind) {
    R3TemplateDependencyKind[(R3TemplateDependencyKind['Directive'] = 0)] =
      'Directive';
    R3TemplateDependencyKind[(R3TemplateDependencyKind['Pipe'] = 1)] = 'Pipe';
    R3TemplateDependencyKind[(R3TemplateDependencyKind['NgModule'] = 2)] =
      'NgModule';
  })(
  ...
  class ParseSpan {
    ...
    toAbsolute(absoluteOffset) {
      return new AbsoluteSourceSpan(
        absoluteOffset + this.start,
        absoluteOffset + this.end
      );
    }
  }
  class AST {
  ...
  class ThisReceiver extends ImplicitReceiver {
    visit(visitor, context = null) {
      var _a;
      return (_a = visitor.visitThisReceiver) === null || _a === void 0
        ? void 0
        : _a.call(visitor, this, context);
    }
  }
  /**
  ...
  class AstTransformer {
    ...
    visitUnary(ast, context) {
      switch (ast.operator) {
        case '+':
          return Unary.createPlus(
            ast.span,
            ast.sourceSpan,
            ast.expr.visit(this)
          );
        case '-':
          return Unary.createMinus(
            ast.span,
            ast.sourceSpan,
            ast.expr.visit(this)
          );
  ...
  (function (ParsedPropertyType) {
    ...
    ParsedPropertyType[(ParsedPropertyType['LITERAL_ATTR'] = 1)] =
      'LITERAL_ATTR';
  ...
  function convertActionBinding(
    ...
    const actionStmts = [];
    flattenStatements(
      actionWithoutBuiltins.visit(visitor, _Mode.Statement),
      actionStmts
    );
   ...
   */
  function convertPropertyBinding(
    localResolver,
    implicitReceiver,
    ...
    const outputExpr = expressionWithoutBuiltins.visit(
      visitor,
      _Mode.Expression
    );
   ...
   */
  function convertUpdateArguments(
    localResolver,
    contextVariableExpression,
    expressionWithArgumentsToExtract,
    bindingId
  ) {
    const visitor = new _AstToIrVisitor(
      localResolver,
    ...
    const outputExpr = visitor.visitInterpolation(
      expressionWithArgumentsToExtract,
      _Mode.Expression
    );
    if (visitor.usesImplicitReceiver) {
  ...
  class _BuiltinAstConverter extends AstTransformer {
    ...
    visitPipe(ast, context) {
      const args = [ast.exp, ...ast.args].map((ast) =>
        ast.visit(this, context)
      );
  ...
  class _AstToIrVisitor {
    ...
    visitKeyedRead(ast, mode) {
      ...
      if (leftMostSafe) {
        ...
        return convertToStatementIfNeeded(
          mode,
          this._visit(ast.receiver, _Mode.Expression).key(
            this._visit(ast.key, _Mode.Expression)
          )
        );
      }
    }
    ...
    visitLiteralPrimitive(ast, mode) {
      ...
      return convertToStatementIfNeeded(
        mode,
        literal(ast.value, type, this.convertSourceSpan(ast.span))
      );
    }
    _getLocal(name, receiver) {
      var _a;
      if (
        ((_a = this._localResolver.globals) === null || _a === void 0
          ? void 0
          : _a.has(name)) &&
        receiver instanceof ThisReceiver
      ) {
        return null;
      }
    ...
    visitPrefixNot(ast, mode) {
      return convertToStatementIfNeeded(
        mode,
        not(this._visit(ast.expression, _Mode.Expression))
      );
    }
    visitNonNullAssert(ast, mode) {
      return convertToStatementIfNeeded(
        mode,
        this._visit(ast.expression, _Mode.Expression)
      );
    }
    ...
    visitPropertyWrite(ast, mode) {
      ...
      if (receiver === this._implicitReceiver) {
        ...
        if (localExpr) {
          if (localExpr instanceof ReadPropExpr) {
            ...
            const value =
              ast.value instanceof PropertyRead ? ast.value.name : undefined;
            throw new Error(
      ...
      return convertToStatementIfNeeded(
        mode,
        varExpr.set(this._visit(ast.value, _Mode.Expression))
      );
    }
    ...
    convertSafeAccess(ast, leftMostSafe, mode) {
      ...
      let guardedExpression = this._visit(
      ...
      return convertToStatementIfNeeded(
        mode,
        condition.conditional(NULL_EXPR, access)
      );
    }
    ...
    needsTemporaryInSafeAccess(ast) {
      ...
      return ast.visit({
        ...
        visitConditional(ast) {
          return (
            visit(this, ast.condition) ||
            visit(this, ast.trueExp) ||
    ...
    releaseTemporary(temporary) {
      this._currentTemporary--;
      if (
        temporary.name != temporaryName(this.bindingId, this._currentTemporary)
      ) {
  ...
  */
  class ShadowCss {
    ...
    _convertColonHost(cssText) {
      return cssText.replace(
        _cssColonHostRe,
        (_, hostSelectors, otherSelectors) => {
          if (hostSelectors) {
            const convertedSelectors = [];
            const hostSelectorArray = hostSelectors
              .split(',')
              .map((p) => p.trim());
            for (const hostSelector of hostSelectorArray) {
              ...
              const convertedSelector =
                ...
                hostSelector.replace(_polyfillHost, '') +
                otherSelectors;
      ...
      return cssText.replace(_cssColonHostContextReGlobal, (selectorText) => {
        ...
        return contextSelectorGroups
          .map((contextSelectors) =>
            combineHostContextSelectors(contextSelectors, selectorText)
          )
          .join(', ');
      });
    }
        ...
        .map((deepParts) => {
          ...
          const applyScope = (shallowPart) => {
            if (this._selectorNeedsScoping(shallowPart, scopeSelector)) {
              return strict
                ? this._applyStrictSelectorScope(
                    shallowPart,
                    scopeSelector,
                    hostSelector
                  )
                : this._applySelectorScope(
                    shallowPart,
                    scopeSelector,
                    hostSelector
                  );
    ...
    _applySelectorScope(selector, scopeSelector, hostSelector) {
      ...
      return this._applySimpleSelectorScope(
        selector,
        scopeSelector,
        hostSelector
      );
    ...
    _applySimpleSelectorScope(selector, scopeSelector, hostSelector) {
      ...
      if (_polyfillHostRe.test(selector)) {
        const replaceBy = this.strictStyling
          ? `[${hostSelector}]`
          : scopeSelector;
        return selector
    ...
    _applyStrictSelectorScope(selector, scopeSelector, hostSelector) {
      ...
      const _scopeSelectorPart = (p) => {
        ...
        if (p.indexOf(_polyfillHostNoCombinator) > -1) {
          scopedP = this._applySimpleSelectorScope(
            p,
            scopeSelector,
            hostSelector
          );
  ...
  class SafeSelector {
    ...
    restore(content) {
      return content.replace(
        /__ph-(\d+)__/g,
        (_ph, index) => this.placeholders[+index]
      );
    }
    content() {
  ...
  const _cssContentRuleRe =
    /(polyfill-rule)[^}]*(content:[\s]*(['"])(.*?)\3)[;\s]*[^}]*}/gim;
  ...
  class StylingBuilder {
    ...
    registerBoundInput(input) {
      ...
      switch (input.type) {
        case 0 /* BindingType.Property */:
          binding = this.registerInputBasedOnName(
            name,
            input.value,
            input.sourceSpan
          );
        ...
        case 3 /* BindingType.Style */:
          binding = this.registerStyleInput(
            name,
            false,
            input.value,
            input.sourceSpan,
    ...
    registerInputBasedOnName(name, expression, sourceSpan) {
      ...
      const isStyle =
        name === 'style' || prefix === 'style.' || prefix === 'style!';
      const isClass =
        !isStyle &&
        (name === 'class' || prefix === 'class.' || prefix === 'class!');
      if (isStyle || isClass) {
    ...
    populateInitialStylingAttrs(attrs) {
      ...
      if (this._initialStyleValues.length) {
        ...
        for (let i = 0; i < this._initialStyleValues.length; i += 2) {
          attrs.push(
            literal(this._initialStyleValues[i]),
            literal(this._initialStyleValues[i + 1])
          );
        }
      }
    }
    ...
    buildClassMapInstruction(valueConverter) {
      if (this._classMapInput) {
        return this._buildMapBasedInstruction(
          valueConverter,
          true,
          this._classMapInput
        );
        ...
        calls: [
          {
            ...
            params: (convertFn) => {
              ...
              const params = Array.isArray(convertResult)
                ? convertResult
                : [convertResult];
              return params;
            },
    ...
    _buildSingleInputs(
      ...
      inputs.forEach((input) => {
        ...
        if (
          previousInstruction &&
          previousInstruction.reference === referenceForCall
        ) {
    ...
    buildUpdateLevelInstructions(valueConverter) {
      const instructions = [];
      if (this.hasBindings) {
        const styleMapInstruction =
          this.buildStyleMapInstruction(valueConverter);
        if (styleMapInstruction) {
          instructions.push(styleMapInstruction);
        }
        const classMapInstruction =
          this.buildClassMapInstruction(valueConverter);
  ...
  class Token {
    ...
    isOperator(operator) {
      return (
        this.type == exports.TokenType.Operator && this.strValue == operator
      );
    }
    isIdentifier() {
    ...
    isKeywordUndefined() {
      return (
        this.type == exports.TokenType.Keyword && this.strValue == 'undefined'
      );
    }
    isKeywordTrue() {
  ...
  class _Scanner {
    ...
    advance() {
      this.peek =
        ++this.index >= this.length ? $EOF : this.input.charCodeAt(this.index);
    }
    scanToken() {
      ...
      this.advance();
      return this.error(
        `Unexpected character [${String.fromCharCode(peek)}]`,
        0
      );
    }
  ...
  class Parser$1 {
    ...
    _reportError(message, input, errLocation, ctxLocation) {
      this.errors.push(
        new ParserError(message, input, errLocation, ctxLocation)
      );
    }
    ...
    parseTemplateBindings(
      ...
      return parser.parseTemplateBindings({
        source: templateKey,
        span: new AbsoluteSourceSpan(
          absoluteKeyOffset,
          absoluteKeyOffset + templateKey.length
        ),
      });
    }
    parseInterpolation(
    ...
    splitInterpolation(
      ...
      while (i < input.length) {
        if (!atInterpolation) {
          ...
          const startInOriginalTemplate =
            (_a =
              inputToTemplateIndexMap === null ||
              inputToTemplateIndexMap === void 0
                ? void 0
                : inputToTemplateIndexMap.get(fullStart)) !== null &&
            _a !== void 0
              ? _a
              : fullStart;
  ...
  class _ParseAST {
    ...
    span(start, artificialEndIndex) {
      ...
      if (
        artificialEndIndex !== undefined &&
        artificialEndIndex > this.currentEndIndex
      ) {
      ...
      if (this.consumeOptionalOperator('|')) {
        ...
        do {
          ...
          if (nameId !== null) {
            ...
            nameSpan = new ParseSpan(fullSpanEnd, fullSpanEnd).toAbsolute(
              this.absoluteOffset
            );
          }
          const args = [];
    ...
    parseAccessMember(readReceiver, start, isSafe) {
      ...
      const id = this.withContext(ParseContextFlags.Writable, () => {
        var _a;
        const id =
          (_a = this.expectIdentifierOrKeyword()) !== null && _a !== void 0
            ? _a
            : '';
        if (id.length === 0) {
          this.error(
            `Expected identifier for property access`,
            readReceiver.span.end
          );
        }
        return id;
      });
    ...
    parseCall(receiver, start, isSafe) {
      ...
      const argumentSpan = this.span(argumentStart, this.inputIndex).toAbsolute(
        this.absoluteOffset
      );
      this.expectCharacter($RPAREN);
      this.rparensExpected--;
    ...
    consumeOptionalAssignment() {
      ...
      if (
        this.parseFlags & 2 /* ParseFlags.AssignmentEvent */ &&
        this.next.isOperator('!') &&
      ...
      while (this.index < this.tokens.length) {
        ...
        if (letBinding) {
          ...
          if (binding) {
            ...
            key.source =
              templateKey.source +
              key.source.charAt(0).toUpperCase() +
              key.source.substring(1);
    ...
    parseAsBinding(value) {
      ...
      const key = this.expectTemplateBindingKey();
      this.consumeStatementTerminator();
      const sourceSpan = new AbsoluteSourceSpan(
        value.span.start,
        this.currentAbsoluteOffset
      );
    ...
    consumeStatementTerminator() {
      this.consumeOptionalCharacter($SEMICOLON) ||
        this.consumeOptionalCharacter($COMMA);
    }
    /**
  ...
  function getIndexMapForOriginalTemplate(interpolatedTokens) {
    ...
    while (tokenIndex < interpolatedTokens.length) {
      ...
      if (currentToken.type === 9 /* MlParserTokenType.ENCODED_ENTITY */) {
        ...
        const lengthOfParts = currentToken.parts.reduce(
  ...
  class _Tokenizer {
    ...
    constructor(_file, _getTagDefinition, options) {
      ...
      this._interpolationConfig =
        options.interpolationConfig || DEFAULT_INTERPOLATION_CONFIG;
      this._leadingTriviaCodePoints =
        options.leadingTriviaChars &&
        options.leadingTriviaChars.map((c) => c.codePointAt(0) || 0);
      ...
      this._i18nNormalizeLineEndingsInICUs =
        options.i18nNormalizeLineEndingsInICUs || false;
      try {
        this._cursor.init();
      } catch (e) {
        this.handleError(e);
    ...
    _tokenizeExpansionForm() {
      ...
      if (
        isExpansionCaseStart(this._cursor.peek()) &&
    ...
    _endToken(parts, end) {
      ...
      const token = {
        ...
        parts,
        sourceSpan: (end !== null && end !== void 0
          ? end
          : this._cursor
        ).getSpan(this._currentTokenStart, this._leadingTriviaCodePoints),
      };
    ...
    _consumeEntity(textTokenType) {
      ...
      if (this._attemptCharCode($HASH)) {
        ...
        if (this._cursor.peek() != $SEMICOLON) {
          ...
          // message.
          this._cursor.advance();
          const entityType = isHex
            ? CharacterReferenceType.HEX
            : CharacterReferenceType.DEC;
          throw this._createError(
    ...
    _consumePrefixAndName() {
      ...
      let prefix = '';
      while (
        this._cursor.peek() !== $COLON &&
        !isPrefixEnd(this._cursor.peek())
      ) {
        this._cursor.advance();
      }
      let nameStart;
    ...
    _consumeTagOpen(start) {
      ...
      const contentTokenType =
        this._getTagDefinition(tagName).getContentType(prefix);
      if (contentTokenType === exports.TagContentType.RAW_TEXT) {
        this._consumeRawTextWithTagClose(prefix, tagName, false);
      } else if (
        contentTokenType === exports.TagContentType.ESCAPABLE_RAW_TEXT
      ) {
    ...
    _consumeAttributeName() {
      ...
      if (attrNameStart === $SQ || attrNameStart === $DQ) {
        throw this._createError(
          _unexpectedCharacterErrorMsg(attrNameStart),
          this._cursor.getSpan()
        );
      }
    ...
    isExpansionFormStart() {
      ...
      if (this._interpolationConfig) {
        const start = this._cursor.clone();
        const isInterpolation = this._attemptStr(
  ...
  class PlainCharacterCursor {
    ...
    getSpan(start, leadingTriviaCodePoints) {
      ...
      if (leadingTriviaCodePoints) {
        while (
          this.diff(start) > 0 &&
          leadingTriviaCodePoints.indexOf(start.peek()) !== -1
        ) {
          if (fullStart === start) {
            start = start.clone();
          }
      ...
      const fullStartLocation =
        fullStart !== start
          ? this.locationFromCursor(fullStart)
          : startLocation;
  ...
  class EscapedCharacterCursor extends PlainCharacterCursor {
    ...
    decodeHexDigits(start, length) {
      const hex = this.input.slice(
        start.internalState.offset,
        start.internalState.offset + length
      );
  ...
  class _TreeBuilder {
    ...
    _popElement(fullName, endSourceSpan) {
      ...
      for (
        ...
        if (el.name === fullName) {
          ...
          el.sourceSpan.end =
            endSourceSpan !== null ? endSourceSpan.end : el.sourceSpan.end;
    ...
    _consumeAttr(attrName) {
      ...
      const valueSpan =
        ...
        valueEnd &&
        new ParseSourceSpan(
          valueStartSpan.start,
          valueEnd,
          valueStartSpan.fullStart
        );
  ...
  class WhitespaceVisitor {
    ...
    visitText(text, context) {
      ...
      const hasExpansionSibling =
        context &&
        (context.prev instanceof Expansion ||
          context.next instanceof Expansion);
      if (isNotBlank || hasExpansionSibling) {
        // Process the whitespace in the tokens of this Text node
        const tokens = text.tokens.map((token) =>
          token.type === 5 /* TokenType.TEXT */
            ? createWhitespaceProcessedTextToken(token)
            : token
        );
  ...
  class DomElementSchemaRegistry extends ElementSchemaRegistry {
    constructor() {
      ...
      SCHEMA.forEach((encodedType) => {
        ...
        const superType =
          superName && this._schema.get(superName.toLowerCase());
        if (superType) {
          for (const [prop, value] of superType) {
            type.set(prop, value);
          }
          for (const superEvent of this._eventSchema.get(
    ...
    hasProperty(tagName, propName, schemaMetas) {
      ...
      if (tagName.indexOf('-') > -1) {
        ...
        if (
          schemaMetas.some(
            (schema) => schema.name === CUSTOM_ELEMENTS_SCHEMA.name
          )
        ) {
    ...
    getMappedPropName(propName) {
      var _a;
      return (_a = _ATTR_TO_PROP.get(propName)) !== null && _a !== void 0
        ? _a
        : propName;
    }
    ...
    allKnownAttributesOfElement(tagName) {
      ...
      return Array.from(elementProperties.keys()).map((prop) => {
        var _a;
        return (_a = _PROP_TO_ATTR.get(prop)) !== null && _a !== void 0
          ? _a
          : prop;
      });
    }
    allKnownEventsOfElement(tagName) {
      var _a;
      return Array.from(
        (_a = this._eventSchema.get(tagName.toLowerCase())) !== null &&
          _a !== void 0
          ? _a
          : []
      );
  ...
  function isTrustedTypesSink(tagName, propName) {
    ...
    propName = propName.toLowerCase();
    return (
      TRUSTED_TYPES_SINKS.has(tagName + '|' + propName) ||
  ...
  class BindingParser {
    ...
    parseInterpolation(value, sourceSpan, interpolatedTokens) {
      ...
      try {
        ...
        return this._exprParser.wrapLiteralPrimitive(
          'ERROR',
          sourceInfo,
          absoluteOffset
        );
    ...
    parseInlineTemplateBinding(
      ...
      const absoluteKeyOffset =
        sourceSpan.start.offset + TEMPLATE_ATTR_PREFIX$1.length;
      ...
      for (const binding of bindings) {
        ...
        if (binding instanceof VariableBinding) {
          ...
          const valueSpan = binding.value
            ...
            : undefined;
          targetVars.push(
            new ParsedVariable(key, value, bindingSpan, keySpan, valueSpan)
          );
        } else if (binding.value) {
          const srcSpan = isIvyAst ? bindingSpan : sourceSpan;
          const valueSpan = moveParseSourceSpan(
            sourceSpan,
            binding.value.ast.sourceSpan
          );
      ...
      try {
        ...
        bindingsResult.warnings.forEach((warning) => {
          this._reportError(
            warning,
            sourceSpan,
            exports.ParseErrorLevel.WARNING
          );
        });
      ...
      if (isAnimationLabel(name)) {
        ...
        targetProps.push(
          new ParsedProperty(
            ...
            exports.ParsedPropertyType.LITERAL_ATTR,
            sourceSpan,
            keySpan,
            valueSpan
          )
    ...
    _parsePropertyAst(
      ...
      targetProps.push(
        new ParsedProperty(
          name,
          ast,
          exports.ParsedPropertyType.DEFAULT,
          sourceSpan,
          keySpan,
          valueSpan
        )
    ...
    _parseAnimation(
      ...
      targetProps.push(
        new ParsedProperty(
          name,
          ast,
          exports.ParsedPropertyType.ANIMATION,
          sourceSpan,
          keySpan,
          valueSpan
        )
    ...
    createBoundElementProperty(
      ...
      if (parts.length > 1) {
        if (parts[0] == ATTRIBUTE_PREFIX) {
          ...
          if (!skipValidation) {
            this._validatePropertyOrAttributeName(
              boundPropertyName,
              boundProp.sourceSpan,
              true
            );
    ...
    calcPossibleSecurityContexts(selector, propName, isAttribute) {
      ...
      return calcPossibleSecurityContexts(
        this._schemaRegistry,
        selector,
        prop,
        isAttribute
    ...
    _parseAction(value, isAssignmentEvent, sourceSpan) {
      ...
      const absoluteOffset =
        sourceSpan && sourceSpan.start ? sourceSpan.start.offset : 0;
      try {
  ...
  function calcPossibleSecurityContexts(
    ...
    CssSelector.parse(selector).forEach((selector) => {
      const elementNames = selector.element
        ? [selector.element]
  ...
  (function (PreparsedElementType) {
    PreparsedElementType[(PreparsedElementType['NG_CONTENT'] = 0)] =
      'NG_CONTENT';
    PreparsedElementType[(PreparsedElementType['STYLE'] = 1)] = 'STYLE';
    PreparsedElementType[(PreparsedElementType['STYLESHEET'] = 2)] =
      'STYLESHEET';
  ...
  class HtmlAstToIvyAst {
    ...
    visitElement(element) {
      ...
      for (const attribute of element.attrs) {
        ...
        if (normalizedName.startsWith(TEMPLATE_ATTR_PREFIX)) {
          ...
          const templateKey = normalizedName.substring(
            TEMPLATE_ATTR_PREFIX.length
          );
      ...
      if (preparsedElement.type === PreparsedElementType.NG_CONTENT) {
        ...
        if (
          ...
          !element.children.every(
            (node) => isEmptyTextNode(node) || isCommentNode(node)
          )
        ) {
          this.reportError(
      ...
      if (elementHasInlineTemplate) {
        ...
        const hoistedAttrs =
          parsedElement instanceof Element$1
            ? {
        ...
        const i18n =
          isTemplateElement && isI18nRootElement ? undefined : element.i18n;
        const name =
          parsedElement instanceof Template ? null : parsedElement.name;
        parsedElement = new Template(
          name,
    ...
    visitExpansion(expansion) {
      ...
      Object.keys(message.placeholders).forEach((key) => {
        ...
        if (key.startsWith(I18N_ICU_VAR_PREFIX)) {
          ...
          const ast = this.bindingParser.parseInterpolationExpression(
            value.text,
            value.sourceSpan
          );
          vars[formattedKey] = new BoundText(ast, value.sourceSpan);
        } else {
          placeholders[key] = this._visitTextWithInterpolation(
            value.text,
            value.sourceSpan,
            null
          );
    ...
    visitComment(comment) {
      if (this.options.collectCommentNodes) {
        this.commentNodes.push(
          new Comment$1(comment.value || '', comment.sourceSpan)
        );
      }
      return null;
    }
    ...
    parseAttribute(
      ...
      function createKeySpan(srcSpan, prefix, identifier) {
        ...
        const keySpanStart = srcSpan.start.moveBy(
          prefix.length + normalizationAdjustment
        );
      ...
      if (
        ...
        const identifier = name.substring(
          delims.start.length,
          name.length - delims.end.length
        );
      ...
      const hasBinding = this.bindingParser.parsePropertyInterpolation(
        ...
        parsedProperties,
        keySpan,
        (_a = attribute.valueTokens) !== null && _a !== void 0 ? _a : null
      );
      return hasBinding;
    }
    _visitTextWithInterpolation(value, sourceSpan, interpolatedTokens, i18n) {
      const valueNoNgsp = replaceNgsp(value);
      const expr = this.bindingParser.parseInterpolation(
        valueNoNgsp,
        sourceSpan,
        interpolatedTokens
      );
      return expr
        ? new BoundText(expr, sourceSpan, i18n)
        : new Text$3(valueNoNgsp, sourceSpan);
    }
    parseVariable(
      identifier,
      value,
      ...
      variables.push(
        new Variable(identifier, value, sourceSpan, keySpan, valueSpan)
      );
    }
    parseReference(
      identifier,
      ...
      if (identifier.indexOf('-') > -1) {
        ...
        references.some((reference) => reference.name === identifier)
      ) {
        this.reportError(
          `Reference "#${identifier}" is defined more than once`,
          sourceSpan
        );
      }
      references.push(
        new Reference(identifier, value, sourceSpan, keySpan, valueSpan)
      );
    }
  ...
  class I18nContext {
    ...
    appendBoundText(node) {
      const phs = assembleBoundTextPlaceholders(
        node,
        this.bindings.size,
        this.id
      );
      phs.forEach((values, key) =>
        updatePlaceholderMap(this.placeholders, key, ...values)
      );
    }
    ...
    reconcileChildContext(context) {
      ...
      childPhs.forEach((values, key) => {
        ...
        const tmplIdx = phs.findIndex(
          findTemplateFn(context.id, context.templateIndex)
        );
        if (tmplIdx >= 0) {
    ...
    switch (value.type) {
      case TagType.ELEMENT:
        ...
        if (value.closed) {
          return (
            element(value, true) +
            (value.tmpl ? template(value.tmpl, true) : '')
          );
        }
  ...
  class IcuSerializerVisitor {
    ...
    visitIcu(icu) {
      ...
      const result = `{${icu.expressionPlaceholder}, ${
        icu.type
      }, ${strCases.join(' ')}}`;
      return result;
    }
  ...
  class PlaceholderRegistry {
    ...
    getStartTagPlaceholderName(tag, attrs, isVoid) {
      ...
      const name = this._generateUniqueName(
        isVoid ? baseName : `START_${baseName}`
      );
  ...
  class _I18nVisitor {
    ...
    visitElement(el, context) {
      ...
      const startPhName =
        context.placeholderRegistry.getStartTagPlaceholderName(
          el.name,
          attrs,
          isVoid
        );
      ...
      if (!isVoid) {
        ...
        context.placeholderToContent[closePhName] = {
          text: `</${el.name}>`,
          sourceSpan:
            (_a = el.endSourceSpan) !== null && _a !== void 0
              ? _a
              : el.sourceSpan,
        };
      }
      const node = new TagPlaceholder(
        el.name,
        attrs,
        startPhName,
        closePhName,
    ...
    visitAttribute(attribute, context) {
      const node =
        attribute.valueTokens === undefined ||
    ...
    visitExpansion(icu, context) {
      ...
      icu.cases.forEach((caze) => {
        i18nIcuCases[caze.value] = new Container(
      ...
      if (context.isIcu || context.icuDepth > 0) {
        ...
        const expPh = context.placeholderRegistry.getUniquePlaceholder(
          `VAR_${icu.type}`
        );
      ...
      const phName = context.placeholderRegistry.getPlaceholderName(
        'ICU',
        icu.sourceSpan.toString()
      );
      context.placeholderToMessage[phName] = this.toI18nMessage(
        [icu],
        '',
        '',
        '',
      ...
      for (const token of tokens) {
        switch (token.type) {
          ...
          case 17 /* TokenType.ATTR_VALUE_INTERPOLATION */:
            ...
            const baseName =
              extractPlaceholderName(expression) || 'INTERPOLATION';
            const phName = context.placeholderRegistry.getPlaceholderName(
              baseName,
              expression
            );
  ...
  function assertEquivalentNodes(previousNodes, nodes) {
    ...
    if (
      previousNodes.some((node, i) => nodes[i].constructor !== node.constructor)
    ) {
      throw new Error(
  ...
  const setI18nRefs = (htmlNode, i18nNode) => {
    if (htmlNode instanceof NodeWithI18n) {
      if (
        i18nNode instanceof IcuPlaceholder &&
        htmlNode.i18n instanceof Message
      ) {
  ...
  class I18nMetaVisitor {
      ...
      if (hasI18nAttrs(element)) {
        ...
        for (const attr of element.attrs) {
          if (attr.name === I18N_ATTR) {
            ...
            message = this._generateI18nMessage(
              element.children,
              i18n,
              setI18nRefs
            );
    ...
    _setMessageId(message, meta) {
      if (!message.id) {
        message.id =
          (meta instanceof Message && meta.id) || decimalDigest(message);
      }
    }
    /**
  ...
  function parseI18nMeta(meta = '') {
    ...
    if (meta) {
      ...
      [meaningAndDesc, customId] =
        idIndex > -1
          ? [meta.slice(0, idIndex), meta.slice(idIndex + 2)]
          : [meta, ''];
      [meaning, description] =
        descIndex > -1
          ? [
              meaningAndDesc.slice(0, descIndex),
              meaningAndDesc.slice(descIndex + 1),
            ]
          : ['', meaningAndDesc];
    }
   ...
   * ```
   */
  function createGoogleGetMsgStatements(
    variable$1,
    message,
    closureVar,
    placeholderValues
    ...
    const googGetMsgStmt = closureVar
      .set(variable(GOOG_GET_MSG).callFn(args))
      .toConstDecl();
    googGetMsgStmt.addLeadingComment(i18nMetaToJSDoc(message));
    const i18nAssignmentStmt = new ExpressionStatement(
      variable$1.set(closureVar)
    );
  ...
  function serializeI18nMessageForGetMsg(message) {
    return message.nodes
      .map((node) => node.visit(serializerVisitor, null))
      .join('');
  }
  ...
  function createLocalizeStatements(variable, message, params) {
    ...
    const localizedString$1 = localizedString(
      message,
      messageParts,
      placeHolders,
      expressions,
    ...
    visitTagPlaceholder(ph) {
      ...
      this.pieces.push(
        this.createPlaceholderPiece(
          ph.startName,
          (_a = ph.startSourceSpan) !== null && _a !== void 0
            ? _a
            : ph.sourceSpan
        )
      );
      if (!ph.isVoid) {
        ...
        this.pieces.push(
          this.createPlaceholderPiece(
            ph.closeName,
            (_b = ph.endSourceSpan) !== null && _b !== void 0
              ? _b
              : ph.sourceSpan
          )
        );
    ...
    visitIcuPlaceholder(ph) {
      this.pieces.push(
        this.createPlaceholderPiece(
          ph.name,
          ph.sourceSpan,
          this.placeholderToMessage[ph.name]
        )
      );
    }
  ...
  function processMessagePieces(pieces) {
    ...
    for (let i = 0; i < pieces.length; i++) {
      ...
      if (part instanceof LiteralPiece) {
        ...
        if (pieces[i - 1] instanceof PlaceholderPiece) {
          ...
          messageParts.push(
            createEmptyMessagePart(pieces[i - 1].sourceSpan.end)
          );
        }
      }
    }
    if (pieces[pieces.length - 1] instanceof PlaceholderPiece) {
      ...
      messageParts.push(
        createEmptyMessagePart(pieces[pieces.length - 1].sourceSpan.end)
      );
    }
  ...
  function renderFlagCheckIfStmt(flags, statements) {
    return ifStmt(
      variable(RENDER_FLAGS).bitwiseAnd(literal(flags), null, false),
      statements
    );
  }
  function prepareEventListenerParameters(
    eventAst,
    handlerName = null,
    scope = null
  ) {
    ...
    if (target && !GLOBAL_TARGET_RESOLVERS.has(target)) {
      throw new Error(`Unexpected global target '${target}' defined for '${name}' event.
        Supported list of global targets: ${Array.from(
          GLOBAL_TARGET_RESOLVERS.keys()
        )}.`);
    }
    const eventArgumentName = '$event';
    const implicitReceiverAccesses = new Set();
    const implicitReceiverExpr =
      scope === null || scope.bindingLevel === 0
        ? variable(CONTEXT_NAME)
        : scope.getOrCreateSharedContextVar(0);
    const bindingStatements = convertActionBinding(
      scope,
      implicitReceiverExpr,
      handler,
      'b',
    ...
    if (restoreViewStatement) {
      ...
      if (lastStatement instanceof ReturnStatement) {
        statements[statements.length - 1] = new ReturnStatement(
          invokeInstruction(
            lastStatement.value.sourceSpan,
        ...
        statements.push(
          new ExpressionStatement(
            invokeInstruction(null, Identifiers.resetView, [])
          )
        );
      }
    }
    const eventName =
      type === 1 /* ParsedEventType.Animation */
        ? prepareSyntheticListenerName(name, phase)
        : name;
    ...
    if (target) {
      params.push(
        literal(false), // `useCapture` flag, defaults to `false`
  ...
  class TemplateDefinitionBuilder {
    constructor(
      ...
      this.fileBasedI18nSuffix =
        relativeContextFilePath.replace(/[^A-Za-z0-9]/g, '_') + '_';
      this._valueConverter = new ValueConverter(
        constantPool,
        () => this.allocateDataSlot(),
        (numSlots) => this.allocatePureFunctionSlots(numSlots),
        (name, localName, slot, value) => {
          this._bindingScope.set(this.level, localName, value);
          this.creationInstruction(null, Identifiers.pipe, [
            literal(slot),
            literal(name),
          ]);
        }
    ...
    buildTemplateFunction(
      ...
      if (this.level === 0 && this._ngContentReservedSlots.length) {
        ...
        if (
          ...
          const r3ReservedSlots = this._ngContentReservedSlots.map((s) =>
            s !== '*' ? parseSelectorToR3Selector(s) : s
          );
          parameters.push(
            this.constantPool.getConstLiteral(asLiteral(r3ReservedSlots), true)
          );
        }
      ...
      const creationStatements = getInstructionStatements(
        this._creationCodeFns
      );
      ...
      const updateVariables = this._bindingScope
        .variableDeclarations()
        .concat(this._tempVariables);
      const creationBlock =
        creationStatements.length > 0
          ? [
              renderFlagCheckIfStmt(
                1 /* core.RenderFlags.Create */,
      ...
      this._bindingScope.set(
        ...
        (scope, relativeLevel) => {
          ...
          if (scope.bindingLevel === retrievalLevel) {
            ...
            rhs = sharedCtxVar
              ? sharedCtxVar
              : generateNextContextExpr(relativeLevel);
          }
          // e.g. const $item$ = x(2).$implicit;
          return [
            lhs
              .set(rhs.prop(variable$1.value || IMPLICIT_REFERENCE))
              .toConstDecl(),
          ];
        }
      );
    ...
    i18nAppendBindings(expressions) {
      if (expressions.length > 0) {
        expressions.forEach((expression) =>
          this.i18n.appendBinding(expression)
        );
      }
    }
    i18nBindProps(props) {
    ...
    i18nUpdateRef(context) {
      ...
      if (isRoot && isResolved && !isEmitted && !isSingleI18nIcu(meta)) {
        ...
        let icuMapping = {};
        let params = placeholders.size
          ? placeholdersToParams(placeholders)
          : {};
        if (icus.size) {
          icus.forEach((refs, key) => {
            if (refs.length === 1) {
              ...
              const placeholder = wrapI18nPlaceholder(
                `${I18N_ICU_MAPPING_PREFIX}${key}`
              );
        ...
        const needsPostprocessing =
          Array.from(placeholders.values()).some((value) => value.length > 1) ||
    ...
    i18nStart(span = null, meta, selfClosing) {
      ...
      this.creationInstruction(
        span,
        selfClosing ? Identifiers.i18n : Identifiers.i18nStart,
        params
      );
    }
      ...
      if (bindings.size) {
        for (const binding of bindings) {
          ...
          this.updateInstructionWithAdvance(
            ...
            span,
            Identifiers.i18nExp,
            () => this.convertPropertyBinding(binding)
          );
        }
    ...
    i18nAttributesInstruction(nodeIndex, attrs, sourceSpan) {
      ...
      attrs.forEach((attr) => {
        ...
        if (converted instanceof Interpolation) {
          ...
          i18nAttrArgs.push(
            literal(attr.name),
            this.i18nTranslate(message, params)
          );
          converted.expressions.forEach((expression) => {
            ...
            this.updateInstructionWithAdvance(
              ...
              sourceSpan,
              Identifiers.i18nExp,
              () => this.convertPropertyBinding(expression)
            );
          });
        }
      });
      if (i18nAttrArgs.length > 0) {
        ...
        this.creationInstruction(sourceSpan, Identifiers.i18nAttributes, [
          index,
          constIndex,
        ]);
        if (hasBindings) {
    ...
    visitContent(ngContent) {
      ...
      const projectionSlotIdx =
        this._ngContentSelectorsOffset + this._ngContentReservedSlots.length;
      const parameters = [literal(slot)];
      this._ngContentReservedSlots.push(ngContent.selector);
      const nonContentSelectAttributes = ngContent.attributes.filter(
        (attr) => attr.name.toLowerCase() !== NG_CONTENT_SELECT_ATTR
      );
      const attributes = this.getAttributeExpressions(
        ngContent.name,
        nonContentSelectAttributes,
        [],
        []
      );
    ...
    visitElement(element) {
      ...
      const hasChildren =
        !isI18nRootElement && this.i18n
          ? !hasTextChildrenOnly(element.children)
          : element.children.length > 0;
      const createSelfClosingInstruction =
        !stylingBuilder.hasBindingsWithPipes &&
        element.outputs.length === 0 &&
        boundI18nAttrs.length === 0 &&
        !hasChildren;
      ...
      if (createSelfClosingInstruction) {
        this.creationInstruction(
          element.sourceSpan,
          isNgContainer$1 ? Identifiers.elementContainer : Identifiers.element,
        ...
        if (boundI18nAttrs.length > 0) {
          this.i18nAttributesInstruction(
            elementIndex,
            boundI18nAttrs,
            (_a = element.startSourceSpan) !== null && _a !== void 0
              ? _a
              : element.sourceSpan
          );
        }
        ...
        if (isI18nRootElement) {
          this.i18nStart(
            element.startSourceSpan,
            element.i18n,
            createSelfClosingI18nInstruction
          );
        }
      }
      ...
      const stylingInstructions = stylingBuilder.buildUpdateLevelInstructions(
        this._valueConverter
      );
      const limit = stylingInstructions.length - 1;
      for (let i = 0; i <= limit; i++) {
        const instruction = stylingInstructions[i];
        this._bindingSlots += this.processStylingUpdateInstruction(
          elementIndex,
          instruction
        );
      }
      ...
      allOtherInputs.forEach((input) => {
        ...
        if (inputType === 4 /* BindingType.Animation */) {
          ...
          // defined in...
          const hasValue =
            value instanceof LiteralPrimitive ? !!value.value : true;
          this.allocateBindingSlots(value);
            ...
            if (inputType === 0 /* BindingType.Property */) {
              if (value instanceof Interpolation) {
                ...
                this.interpolatedUpdateInstruction(
                  getPropertyInterpolationExpression(value),
                  elementIndex,
                  attrName,
                  input,
                  value,
              ...
              if (
                ...
                getInterpolationArgsLength(value) > 1
              ) {
                // attr.name="text{{value}}" and friends
                this.interpolatedUpdateInstruction(
                  getAttributeInterpolationExpression(value),
                  elementIndex,
                  attrName,
                  input,
                  value,
                ...
                const boundValue =
                  value instanceof Interpolation ? value.expressions[0] : value;
                // [attr.name]="value" or attr.name="{{value}}"
                // Collect the attribute bindings so that they can be chained at the end.
                attributeBindings.push({
                  span: input.sourceSpan,
                  paramsOrFn: getBindingFunctionParams(
                    () => this.convertPropertyBinding(boundValue),
                    attrName,
                    params
                  ),
                });
      ...
      for (const attributeBinding of attributeBindings) {
        this.updateInstructionWithAdvance(
          elementIndex,
          attributeBinding.span,
          Identifiers.attribute,
          attributeBinding.paramsOrFn
        );
      }
      ...
      if (!createSelfClosingInstruction) {
        ...
        const span =
          (_b = element.endSourceSpan) !== null && _b !== void 0
            ? _b
            : element.sourceSpan;
        if (isI18nRootElement) {
    ...
    visitTemplate(template) {
      ...
      const tagNameWithoutNamespace = template.tagName
        ? splitNsName(template.tagName)[1]
        : template.tagName;
      const contextName = `${this.contextName}${
        template.tagName ? '_' + sanitizeIdentifier(template.tagName) : ''
      }_${templateIndex}`;
      ...
      this._nestedTemplateFns.push(() => {
        ...
        this.constantPool.statements.push(
          templateFunctionExpr.toDeclStmt(templateName)
        );
        if (templateVisitor._ngContentReservedSlots.length) {
          this._ngContentReservedSlots.push(
            ...templateVisitor._ngContentReservedSlots
          );
        }
      });
      ...
      this.creationInstruction(
        ...
        () => {
          parameters.splice(
            2,
            0,
            literal(templateVisitor.getConstCount()),
            literal(templateVisitor.getVarCount())
          );
      ...
      if (tagNameWithoutNamespace === NG_TEMPLATE_TAG_NAME) {
        const [i18nInputs, inputs] = partitionArray(
          template.inputs,
          hasI18nMeta
        );
        ...
        if (i18nInputs.length > 0) {
          this.i18nAttributesInstruction(
            templateIndex,
            i18nInputs,
            (_a = template.startSourceSpan) !== null && _a !== void 0
              ? _a
              : template.sourceSpan
          );
        }
    ...
    visitBoundText(text) {
      ...
      this.creationInstruction(text.sourceSpan, Identifiers.text, [
        literal(nodeIndex),
      ]);
      const value = text.value.visit(this._valueConverter);
      this.allocateBindingSlots(value);
      if (value instanceof Interpolation) {
        this.updateInstructionWithAdvance(
          nodeIndex,
          text.sourceSpan,
          getTextInterpolationExpression(value),
          () => this.getUpdateInstructionArguments(value)
        );
      } else {
    ...
    visitIcu(icu) {
      ...
      const transformFn = (raw) => {
        ...
        return invokeInstruction(null, Identifiers.i18nPostprocess, [
          raw,
          mapLiteral(formatted, true),
        ]);
      };
    ...
    getNgContentSelectors() {
      return this._ngContentReservedSlots.length
        ? this.constantPool.getConstLiteral(
            asLiteral(this._ngContentReservedSlots),
            true
          )
        : null;
    }
      ...
      if (instruction) {
        for (const call of instruction.calls) {
          ...
          this.updateInstructionWithAdvance(
            ...
            () =>
              call.params((value) =>
                call.supportsInterpolation && value instanceof Interpolation
                  ? this.getUpdateInstructionArguments(value)
                  : this.convertPropertyBinding(value)
              )
          );
    ...
    addAdvanceInstructionIfNecessary(nodeIndex, span) {
      if (nodeIndex !== this._currentIndex) {
        ...
        this.instructionFn(this._updateCodeFns, span, Identifiers.advance, [
          literal(delta),
        ]);
    ...
    allocateBindingSlots(value) {
      this._bindingSlots +=
        value instanceof Interpolation ? value.expressions.length : 1;
    }
    /**
    ...
    getUpdateInstructionArguments(value) {
      const { args, stmts } = convertUpdateArguments(
        this,
        this.getImplicitReceiverExpr(),
        value,
        this.bindingContext()
    ...
    getAttributeExpressions(
      ...
      for (const attr of renderAttributes) {
        ...
        if (attr.i18n) {
          ...
          attrExprs.push(
            ...getAttributeNameLiterals(attr.name),
            trustedConstAttribute(elementName, attr)
          );
        }
      }
      ...
      if (inputs.length || outputs.length) {
        ...
        for (let i = 0; i < inputs.length; i++) {
          ...
          if (
            input.type !== 4 /* BindingType.Animation */ &&
            input.type !== 1 /* BindingType.Attribute */
          ) {
        ...
        if (attrExprs.length !== attrsLengthBeforeInputs) {
          attrExprs.splice(
            attrsLengthBeforeInputs,
            0,
            literal(3 /* core.AttributeMarker.Bindings */)
          );
        }
      }
    ...
    addAttrsToConsts(attrs) {
      return attrs.length > 0
        ? this.addToConsts(literalArr(attrs))
        : TYPED_NULL_EXPR;
    }
      ...
      const refsParam = flatten(
        references.map((reference) => {
          ...
          this._bindingScope.set(
            ...
            reference.name,
            lhs,
            0 /* DeclarationPriority.DEFAULT */,
            (scope, relativeLevel) => {
              // e.g. nextContext(2);
              const nextContextStmt =
                relativeLevel > 0
                  ? [generateNextContextExpr(relativeLevel).toStmt()]
                  : [];
              // e.g. const $foo$ = reference(1);
              const refExpr = lhs.set(
                importExpr(Identifiers.reference).callFn([literal(slot)])
              );
  ...
  class ValueConverter extends AstMemoryEfficientTransformer {
    ...
    visitPipe(pipe, context) {
      ...
      const pureFunctionSlot = this.allocatePureFunctionSlots(
        2 + pipe.args.length
      );
      const target = new PropertyRead(
        ...
        pipe.sourceSpan,
        pipe.nameSpan,
        new ImplicitReceiver(pipe.span, pipe.sourceSpan),
        slotPseudoLocal
      );
    ...
    visitLiteralArray(array, context) {
      return new BuiltinFunctionCall(
        array.span,
        array.sourceSpan,
        this.visitAll(array.expressions),
        (values) => {
    ...
    visitLiteralMap(map, context) {
      return new BuiltinFunctionCall(
        map.span,
        map.sourceSpan,
        this.visitAll(map.values),
        (values) => {
          // If the literal has calculated (non-literal) elements  transform it into
          // calls to literal factories that compose the literal and will cache intermediate
          // values.
          const literal = literalMap(
  ...
  function generateNextContextExpr(relativeLevelDiff) {
    return importExpr(Identifiers.nextContext).callFn(
      relativeLevelDiff > 1 ? [literal(relativeLevelDiff)] : []
    );
  }
  function getLiteralFactory(constantPool, literal$1, allocateSlots) {
    ...
    const { identifier, isVarLength } = pureFunctionCallInfo(
  ...
  function getAttributeNameLiterals(name) {
    ...
    if (attributeNamespace) {
      return [
        literal(0 /* core.AttributeMarker.NamespaceURI */),
  ...
  class BindingScope {
    ...
    set(
      ...
      name,
      lhs,
      priority = 0 /* DeclarationPriority.DEFAULT */,
      ...
      if (this.map.has(name)) {
        ...
        error(
          `The name ${name} is already defined in scope to be ${this.map.get(
            name
          )}`
        );
      }
    ...
    maybeGenerateSharedContextVar(value) {
      if (
        value.priority === 1 /* DeclarationPriority.CONTEXT */ &&
        value.retrievalLevel < this.bindingLevel
      ) {
        const sharedCtxObj = this.map.get(
          SHARED_CONTEXT_KEY + value.retrievalLevel
        );
        if (sharedCtxObj) {
    ...
    generateSharedContextVar(retrievalLevel) {
      ...
      this.map.set(SHARED_CONTEXT_KEY + retrievalLevel, {
        ...
        declareLocalCallback: (scope, relativeLevel) => {
          ...
          return [
            lhs.set(generateNextContextExpr(relativeLevel)).toConstDecl(),
          ];
        },
        declare: false,
    ...
    maybeRestoreView() {
      ...
      if (this.isListenerScope()) {
        if (!this.parent.restoreViewVariable) {
          ...
          this.parent.restoreViewVariable = variable(
    ...
    restoreViewStatement() {
      if (this.restoreViewVariable) {
        const restoreCall = invokeInstruction(null, Identifiers.restoreView, [
          this.restoreViewVariable,
        ]);
    ...
    viewSnapshotStatements() {
      ...
      return this.restoreViewVariable
        ? [
            this.restoreViewVariable
              .set(invokeInstruction(null, Identifiers.getCurrentView, []))
              .toConstDecl(),
          ]
        : [];
    }
    ...
    variableDeclarations() {
      ...
      return Array.from(this.map.values())
        ...
        .sort(
          (a, b) =>
            b.retrievalLevel - a.retrievalLevel || b.priority - a.priority
        )
        .reduce((stmts, value) => {
          const levelDiff = this.bindingLevel - value.retrievalLevel;
          const currStmts = value.declareLocalCallback(
            this,
            levelDiff - currentContextLevel
          );
  ...
  function getNgProjectAsLiteral(attribute) {
    ...
    return [
      literal(5 /* core.AttributeMarker.ProjectAs */),
  ...
  function parseTemplate(template, templateUrl, options = {}) {
    ...
    const parseResult = htmlParser.parse(
      ...
      templateUrl,
      Object.assign(
        Object.assign({ leadingTriviaChars: LEADING_TRIVIA_CHARS }, options),
  ...
  function trustedConstAttribute(tagName, attr) {
    ...
    if (isTrustedTypesSink(tagName, attr.name)) {
      switch (
        elementRegistry.securityContext(
          tagName,
          attr.name,
          /* isAttribute */ true
        )
        ...
        case SecurityContext.HTML:
          return taggedTemplate(
            importExpr(Identifiers.trustConstantHtml),
            new TemplateLiteral([new TemplateLiteralElement(attr.value)], []),
            undefined,
            attr.valueSpan
          );
        ...
        case SecurityContext.RESOURCE_URL:
          return taggedTemplate(
            importExpr(Identifiers.trustConstantResourceUrl),
            new TemplateLiteral([new TemplateLiteralElement(attr.value)], []),
            undefined,
            attr.valueSpan
          );
    ...
    const statements = [
      ...
      ifStmt(
        ...
        createLocalizeStatements(
          variable,
          message,
          formatI18nPlaceholderNamesInMap(params, /* useCamelCase */ false)
        )
      ),
    ];
    if (transformFn) {
      statements.push(
        new ExpressionStatement(variable.set(transformFn(variable)))
      );
    }
    return statements;
  }
  ...
  function baseDirectiveFields(meta, constantPool, bindingParser) {
    ...
    definitionMap.set(
      'inputs',
      conditionallyCreateMapObjectLiteral(meta.inputs, true)
    );
    // e.g 'outputs: {a: 'a'}`
    definitionMap.set(
      'outputs',
      conditionallyCreateMapObjectLiteral(meta.outputs)
    );
    if (meta.exportAs !== null) {
      definitionMap.set(
        'exportAs',
        literalArr(meta.exportAs.map((e) => literal(e)))
      );
    }
  ...
  function compileDirectiveFromMetadata(meta, constantPool, bindingParser) {
    const definitionMap = baseDirectiveFields(
      meta,
      constantPool,
      bindingParser
    );
    addFeatures(definitionMap, meta);
    const expression = importExpr(Identifiers.defineDirective).callFn(
      [definitionMap.toLiteralMap()],
      undefined,
      true
    );
  ...
  function compileComponentFromMetadata(meta, constantPool, bindingParser) {
          ...
          constantPool.getConstLiteral(
            literalArr(
              selectorAttributes.map((value) =>
                value != null ? literal(value) : literal(undefined)
              )
            ),
            /* forceShared */ true
          )
    ...
    const templateName = templateTypeName
    ...
    if (constExpressions.length > 0) {
      ...
      if (prepareStatements.length > 0) {
        constsExpr = fn(
          [],
          [...prepareStatements, new ReturnStatement(constsExpr)]
        );
      }
    ...
    if (meta.declarations.length > 0) {
      definitionMap.set(
        ...
        compileDeclarationList(
          literalArr(meta.declarations.map((decl) => decl.type)),
    ...
    if (meta.animations !== null) {
      definitionMap.set(
        'data',
        literalMap([
          { key: 'animation', value: meta.animations, quoted: false },
        ])
      );
    }
    ...
    const expression = importExpr(Identifiers.defineComponent).callFn(
      [definitionMap.toLiteralMap()],
      undefined,
      true
    );
    ...
    switch (mode) {
      ...
      case 2 /* DeclarationListEmitMode.ClosureResolved */:
        ...
        const resolvedList = list
          .prop('map')
          .callFn([importExpr(Identifiers.resolveForwardRef)]);
  ...
  function createContentQueriesFunction(queries, constantPool, name) {
    ...
    for (const query of queries) {
      ...
      createStatements.push(
        importExpr(Identifiers.contentQuery)
          .callFn([
            variable('dirIndex'),
      ...
      const refresh = importExpr(Identifiers.queryRefresh).callFn([
        temporary.set(getQueryList),
      ]);
  ...
  function createViewQueriesFunction(viewQueries, constantPool, name) {
    ...
    viewQueries.forEach((query) => {
      ...
      const queryDefinition = importExpr(Identifiers.viewQuery).callFn(
        prepareQueryParams(query, constantPool)
      );
  ...
  function createHostBindingsFunction(
    ...
    for (const binding of allOtherBindings) {
      ...
      const { bindingName, instruction, isAttribute } =
        getBindingNameAndInstruction(binding);
      const securityContexts = bindingParser
        .calcPossibleSecurityContexts(selector, bindingName, isAttribute)
        .filter((context) => context !== SecurityContext.NONE);
      let sanitizerFn = null;
      if (securityContexts.length) {
        if (
          securityContexts.length === 2 &&
    ...
    if (styleBuilder.hasBindings) {
      ...
      styleBuilder
        .buildUpdateLevelInstructions(getValueConverter())
        .forEach((instruction) => {
          for (const call of instruction.calls) {
      ...
      const bindingFnName =
        binding.type === 1 /* ParsedEventType.Animation */
          ? prepareSyntheticListenerFunctionName(
              bindingName,
              binding.targetOrPhase
            )
          : bindingName;
      const handlerName =
        name && bindingName
          ? `${name}_${bindingFnName}_HostBindingHandler`
          : null;
      const params = prepareEventListenerParameters(
        BoundEvent.fromParsedEvent(binding),
        handlerName
      );
  ...
  class CompilerFacadeImpl {
      ...
      const { expression, statements } = compileInjectable(
        {
          ...
          deps:
            (_a = facade.deps) === null || _a === void 0
              ? void 0
              : _a.map(convertR3DependencyMetadata),
        },
      ...
      const { expression, statements } = compileInjectable(
        {
          ...
          deps:
            (_a = facade.deps) === null || _a === void 0
              ? void 0
              : _a.map(convertR3DeclareDependencyMetadata),
        },
        /* resolveForwardRefs */ true
      );
      return this.jitExpression(
    ...
    compileDirectiveDeclaration(angularCoreEnv, sourceMapUrl, declaration) {
      ...
      const meta = convertDeclareDirectiveFacadeToMetadata(
        declaration,
        typeSourceSpan
      );
      return this.compileDirectiveFromMeta(angularCoreEnv, sourceMapUrl, meta);
    ...
    compileDirectiveFromMeta(angularCoreEnv, sourceMapUrl, meta) {
      ...
      const bindingParser = makeBindingParser();
      const res = compileDirectiveFromMetadata(
        meta,
        constantPool,
        bindingParser
      );
    ...
    compileComponent(angularCoreEnv, sourceMapUrl, facade) {
      ...
      const meta = Object.assign(
        ...
        ),
        {
          ...
          template,
          declarations: facade.declarations.map(
            convertDeclarationFacadeToMetadata
          ),
          ...
          animations:
            facade.animations != null
              ? new WrappedNodeExpr(facade.animations)
              : null,
          viewProviders:
      ...
      return this.compileComponentFromMeta(
        angularCoreEnv,
    ...
    compileComponentDeclaration(angularCoreEnv, sourceMapUrl, declaration) {
      ...
      const meta = convertDeclareComponentFacadeToMetadata(
        declaration,
        typeSourceSpan,
        sourceMapUrl
      );
  ...
  function convertQueryDeclarationToMetadata(declaration) {
    ...
    return {
      ...
      descendants:
        (_b = declaration.descendants) !== null && _b !== void 0 ? _b : false,
      read: declaration.read ? new WrappedNodeExpr(declaration.read) : null,
      static: (_c = declaration.static) !== null && _c !== void 0 ? _c : false,
      emitDistinctChangesOnly:
        (_d = declaration.emitDistinctChangesOnly) !== null && _d !== void 0
          ? _d
          : true,
    };
  }
  ...
  function convertDirectiveFacadeToMetadata(facade) {
    ...
    for (const field in propMetadata) {
      if (propMetadata.hasOwnProperty(field)) {
        propMetadata[field].forEach((ann) => {
          if (isInput(ann)) {
            inputsFromType[field] = ann.bindingPropertyName
    ...
    return Object.assign(Object.assign({}, facade), {
      ...
      internalType: new WrappedNodeExpr(facade.type),
      deps: null,
      host: extractHostBindings(
        facade.propMetadata,
        facade.typeSourceSpan,
        facade.host
      ),
      inputs: Object.assign(
        Object.assign({}, inputsFromMetadata),
        inputsFromType
      ),
      outputs: Object.assign(
        Object.assign({}, outputsFromMetadata),
        outputsFromType
      ),
  ...
  function convertDeclareDirectiveFacadeToMetadata(
    ...
    return {
      ...
      selector:
        (_a = declaration.selector) !== null && _a !== void 0 ? _a : null,
      inputs: (_b = declaration.inputs) !== null && _b !== void 0 ? _b : {},
      outputs: (_c = declaration.outputs) !== null && _c !== void 0 ? _c : {},
      host: convertHostDeclarationToMetadata(declaration.host),
      queries: ((_d = declaration.queries) !== null && _d !== void 0
        ? _d
        : []
      ).map(convertQueryDeclarationToMetadata),
      viewQueries: ((_e = declaration.viewQueries) !== null && _e !== void 0
        ? _e
        : []
      ).map(convertQueryDeclarationToMetadata),
      providers:
        declaration.providers !== undefined
          ? new WrappedNodeExpr(declaration.providers)
          : null,
      exportAs:
        (_f = declaration.exportAs) !== null && _f !== void 0 ? _f : null,
      usesInheritance:
        (_g = declaration.usesInheritance) !== null && _g !== void 0
          ? _g
          : false,
      lifecycle: {
        usesOnChanges:
          (_h = declaration.usesOnChanges) !== null && _h !== void 0
            ? _h
            : false,
      },
      deps: null,
  ...
  function convertHostDeclarationToMetadata(host = {}) {
    var _a, _b, _c;
    return {
      attributes: convertOpaqueValuesToExpressions(
        (_a = host.attributes) !== null && _a !== void 0 ? _a : {}
      ),
  ...
  function convertDeclareComponentFacadeToMetadata(
    ...
    const { template, interpolation } = parseJitTemplate(
      ...
      decl.type.name,
      sourceMapUrl,
      (_a = decl.preserveWhitespaces) !== null && _a !== void 0 ? _a : false,
      decl.interpolation
    );
    const declarations = [];
    if (decl.dependencies) {
      ...
      decl.directives &&
        declarations.push(
          ...decl.directives.map((dir) =>
            convertDirectiveDeclarationToMetadata(dir)
          )
        );
    ...
    return Object.assign(
      ...
      ),
      {
        ...
        declarations,
        viewProviders:
          decl.viewProviders !== undefined
            ? new WrappedNodeExpr(decl.viewProviders)
            : null,
        animations:
          decl.animations !== undefined
            ? new WrappedNodeExpr(decl.animations)
            : null,
        changeDetection:
          (_c = decl.changeDetection) !== null && _c !== void 0
            ? _c
            : exports.ChangeDetectionStrategy.Default,
        encapsulation:
          (_d = decl.encapsulation) !== null && _d !== void 0
            ? _d
            : exports.ViewEncapsulation.Emulated,
        interpolation,
  ...
  function convertDirectiveDeclarationToMetadata(
    ...
    return {
      ...
      exportAs:
        (_c = declaration.exportAs) !== null && _c !== void 0 ? _c : null,
    };
  }
  ...
  function parseJitTemplate(
    ...
    if (parsed.errors !== null) {
      ...
      throw new Error(
        `Errors during JIT compilation of template for ${typeName}: ${errors}`
      );
    }
  ...
  function computeProvidedIn(providedIn) {
    const expression =
      typeof providedIn === 'function'
        ...
        : new LiteralExpr(
            providedIn !== null && providedIn !== void 0 ? providedIn : null
          );
  ...
  function convertR3DependencyMetadata(facade) {
    ...
    const rawToken =
      facade.token === null ? null : new WrappedNodeExpr(facade.token);
    // In JIT mode, if the dep is an `@Attribute()` then we use the attribute name given in
    // `attribute` rather than the `token`.
    const token = isAttributeDep
      ? new WrappedNodeExpr(facade.attribute)
      : rawToken;
  ...
  function convertR3DeclareDependencyMetadata(facade) {
    var _a, _b, _c, _d, _e;
    const isAttributeDep =
      (_a = facade.attribute) !== null && _a !== void 0 ? _a : false;
    const token =
      facade.token === null ? null : new WrappedNodeExpr(facade.token);
    return createR3DependencyMetadata(
      token,
      isAttributeDep,
      (_b = facade.host) !== null && _b !== void 0 ? _b : false,
      (_c = facade.optional) !== null && _c !== void 0 ? _c : false,
      (_d = facade.self) !== null && _d !== void 0 ? _d : false,
      (_e = facade.skipSelf) !== null && _e !== void 0 ? _e : false
    );
  }
      ...
      if (propMetadata.hasOwnProperty(field)) {
        propMetadata[field].forEach((ann) => {
          if (isHostBinding(ann)) {
            ...
            bindings.listeners[ann.eventName || field] = `${field}(${(
              ann.args || []
            ).join(',')})`;
          }
        });
  ...
  function convertDeclarePipeFacadeToMetadata(declaration) {
    ...
    return {
      ...
      isStandalone:
        (_b = declaration.isStandalone) !== null && _b !== void 0 ? _b : false,
    };
  }
  ...
  function preserveWhitespacesDefault(
    ...
    return preserveWhitespacesOption === null
      ? defaultSetting
      : preserveWhitespacesOption;
  }
  ...
  class _Visitor {
        ...
        if (!this._inI18nBlock) {
          if (isOpening) {
            ...
            if (!i18nCommentsWarned && console && console.warn) {
              ...
              const details = comment.sourceSpan.details
                ? `, ${comment.sourceSpan.details}`
                : '';
            ...
            this._blockChildren = [];
            this._blockMeaningAndDesc = comment.value
              .replace(_I18N_COMMENT_PREFIX_REGEXP, '')
              .trim();
        ...
        .forEach(
          (attr) =>
            (explicitAttrNameToValue[
              attr.name.slice(_I18N_ATTR_PREFIX.length)
            ] = attr.value)
        );
      el.attrs.forEach((attr) => {
    ...
    _translateAttributes(el) {
      ...
      attributes.forEach((attr) => {
        if (
          attr.name === _I18N_ATTR ||
          attr.name.startsWith(_I18N_ATTR_PREFIX)
        ) {
        ...
        if (
          attr.value &&
          attr.value != '' &&
          i18nParsedMessageMeta.hasOwnProperty(attr.name)
        ) {
    ...
    _closeTranslatableSection(node, directChildren) {
      ...
      const significantChildren = directChildren.reduce(
        (count, node) => count + (node instanceof Comment ? 0 : 1),
        0
      );
  ...
  function _parseMessageMeta(i18n) {
    ...
    const [meaningAndDesc, id] =
      idIndex > -1
        ? [i18n.slice(0, idIndex), i18n.slice(idIndex + 2)]
        : [i18n, ''];
  ...
  class Xliff extends Serializer {
      ...
      messages.forEach((message) => {
        ...
        message.sources.forEach((source) => {
          ...
          contextGroupTag.children.push(
            new CR(10),
            new Tag(_CONTEXT_TAG, { 'context-type': 'sourcefile' }, [
              new Text$1(source.filePath),
            ]),
            new CR(10),
            new Tag(_CONTEXT_TAG, { 'context-type': 'linenumber' }, [
        ...
        transUnit.children.push(
          new CR(8),
          new Tag(_SOURCE_TAG$1, {}, visitor.serialize(message.nodes)),
          ...contextTags
        );
        if (message.description) {
          transUnit.children.push(
            new CR(8),
            new Tag('note', { priority: '1', from: 'description' }, [
        ...
        if (message.meaning) {
          transUnit.children.push(
            new CR(8),
            new Tag('note', { priority: '1', from: 'meaning' }, [
    ...
    load(content, url) {
      ...
      Object.keys(msgIdToHtml).forEach((msgId) => {
        const { i18nNodes, errors: e } = converter.convert(
          msgIdToHtml[msgId],
          url
        );
        errors.push(...e);
  ...
  class _WriteVisitor$1 {
    ...
    visitIcuPlaceholder(ph, context) {
      const equivText = `{${ph.value.expression}, ${
        ph.value.type
      }, ${Object.keys(ph.value.cases)
        .map((value) => value + ' {...}')
        .join(' ')}}`;
      return [
        new Tag(_PLACEHOLDER_TAG$2, { id: ph.name, 'equiv-text': equivText }),
      ];
    }
    serialize(nodes) {
      return [].concat(...nodes.map((node) => node.visit(this)));
      ...
      switch (element.name) {
        case _UNIT_TAG$1:
          ...
          if (!idAttr) {
            this._addError(
              element,
              `<${_UNIT_TAG$1}> misses the "id" attribute`
            );
          } else {
        ...
        case _TARGET_TAG$1:
          ...
          break;
        case _FILE_TAG:
          const localeAttr = element.attrs.find(
            (attr) => attr.name === 'target-language'
          );
          if (localeAttr) {
      ...
      messages.forEach((message) => {
        ...
        if (message.description || message.meaning) {
          if (message.description) {
            notes.children.push(
              new CR(8),
              new Tag('note', { category: 'description' }, [
                new Text$1(message.description),
              ])
            );
          }
        ...
        message.sources.forEach((source) => {
          notes.children.push(
            new CR(8),
            new Tag('note', { category: 'location' }, [
              new Text$1(
                `${source.filePath}:${source.startLine}${
                  source.endLine !== source.startLine
                    ? ',' + source.endLine
        ...
        segment.children.push(
          new CR(8),
          new Tag(_SOURCE_TAG, {}, visitor.serialize(message.nodes)),
          new CR(6)
        );
  ...
  class Xliff2Parser {
    ...
    visitElement(element, context) {
      switch (element.name) {
        ...
        case _XLIFF_TAG:
          const localeAttr = element.attrs.find(
            (attr) => attr.name === 'trgLang'
          );
          if (localeAttr) {
            this._locale = localeAttr.value;
          }
          const versionAttr = element.attrs.find(
    ...
    visitElement(el, context) {
      switch (el.name) {
        case _PLACEHOLDER_TAG$1:
          ...
          this._addError(
            el,
            `<${_PLACEHOLDER_TAG$1}> misses the "equiv" attribute`
          );
          break;
        case _PLACEHOLDER_SPANNING_TAG:
          ...
          if (!startAttr) {
            this._addError(
              el,
              `<${_PLACEHOLDER_TAG$1}> misses the "equivStart" attribute`
            );
          } else if (!endAttr) {
            this._addError(
              el,
              `<${_PLACEHOLDER_TAG$1}> misses the "equivEnd" attribute`
            );
          } else {
            ...
            const nodes = [];
            return nodes.concat(
              new Placeholder('', startId, el.sourceSpan),
    ...
    load(content, url) {
      ...
      Object.keys(msgIdToHtml).forEach((msgId) => {
        const valueFn = function () {
          const { i18nNodes, errors } = converter.convert(
            msgIdToHtml[msgId],
            url
          );
          if (errors.length) {
      ...
      switch (element.name) {
        case _TRANSLATIONS_TAG:
          ...
          if (this._bundleDepth > 1) {
            this._addError(
              element,
              `<${_TRANSLATIONS_TAG}> elements can not be nested`
            );
          }
        ...
        case _TRANSLATION_TAG:
          ...
          if (!idAttr) {
            this._addError(
              element,
              `<${_TRANSLATION_TAG}> misses the "id" attribute`
            );
          } else {
            const id = idAttr.value;
            if (this._msgIdToHtml.hasOwnProperty(id)) {
  ...
  class I18nToHtmlVisitor {
    ...
    visitIcu(icu, context) {
      const cases = Object.keys(icu.cases).map(
        (k) => `${k} {${icu.cases[k].visit(this)}}`
      );
    ...
    _convertToText(srcMsg) {
      ...
      if (this._i18nNodesByMsgId.hasOwnProperty(id)) {
        ...
        if (
          this._missingTranslationStrategy === MissingTranslationStrategy.Error
        ) {
          const ctx = this._locale ? ` for locale "${this._locale}"` : '';
          this._addError(
            srcMsg.nodes[0],
            `Missing translation for message "${id}"${ctx}`
          );
        } else if (
          this._console &&
          this._missingTranslationStrategy ===
  ...
  class I18NHtmlParser {
    ...
    parse(source, url, options = {}) {
      const interpolationConfig =
        options.interpolationConfig || DEFAULT_INTERPOLATION_CONFIG;
      const parseResult = this._htmlParser.parse(
        source,
        url,
        Object.assign({ interpolationConfig }, options)
      );
  ...
  class MessageBundle {
    ...
    write(serializer, filterSources) {
      ...
      const msgList = Object.keys(messages).map((id) => {
        ...
        const nodes = mapper
          ? mapperVisitor.convert(src.nodes, mapper)
          : src.nodes;
  ...
  class MapPlaceholderNames extends CloneVisitor {
    ...
    visitTagPlaceholder(ph, mapper) {
      ...
      const closeName = ph.closeName
        ? mapper.toPublicName(ph.closeName)
        : ph.closeName;
    ...
    visitPlaceholder(ph, mapper) {
      return new Placeholder(
        ph.value,
        mapper.toPublicName(ph.name),
        ph.sourceSpan
      );
    }
    visitIcuPlaceholder(ph, mapper) {
      return new IcuPlaceholder(
        ph.value,
        mapper.toPublicName(ph.name),
        ph.sourceSpan
      );
  ...
  class R3TargetBinder {
    ...
    bind(target) {
      ...
      const { directives, bindings, references } = DirectiveBinder.apply(
        target.template,
  ...
  class Scope {
    ...
    getChildScope(template) {
      ...
      if (res === undefined) {
        throw new Error(
          `Assertion error: child scope for ${template} not found`
        );
      }
      return res;
    }
  ...
  class DirectiveBinder {
    ...
    visitElementOrTemplate(elementName, node) {
      ...
      const cssSelector = createCssSelector(
        elementName,
        ...
        if (ref.value.trim() === '') {
          ...
          dirTarget =
            directives.find(
              (dir) =>
                dir.exportAs !== null &&
                dir.exportAs.some((value) => value === ref.value)
            ) || null;
      ...
      const setAttributeBinding = (attribute, ioType) => {
        const dir = directives.find((dir) =>
          dir[ioType].hasBindingPropertyName(attribute.name)
        );
  ...
  class TemplateBinder extends RecursiveAstVisitor {
    ...
    static applyWithScope(template, scope) {
      ...
      const binder = new TemplateBinder(
        ...
        nestingLevel,
        scope,
        template instanceof Template ? template : null,
        0
      );
    ...
    visitIcu(icu) {
      ...
      Object.keys(icu.placeholders).forEach((key) =>
        icu.placeholders[key].visit(this)
      );
    }
  ...
  class R3BoundTarget {
    ...
    getEntitiesInTemplateScope(template) {
      var _a;
      return (_a = this.templateEntities.get(template)) !== null &&
        _a !== void 0
        ? _a
        : new Set();
    }
  ...
  function extractTemplateEntities(rootScope) {
    ...
    function extractScopeEntities(scope) {
      ...
      if (scope.parentScope !== null) {
        templateEntities = new Map([
          ...extractScopeEntities(scope.parentScope),
          ...currentEntities,
        ]);
      } else {
  ...
  function compileClassMetadata(metadata) {
    ...
    const fnCall = importExpr(Identifiers.setClassMetadata).callFn([
      metadata.type,
      metadata.decorators,
      (_a = metadata.ctorParameters) !== null && _a !== void 0
        ? _a
        : literal(null),
      (_b = metadata.propDecorators) !== null && _b !== void 0
        ? _b
        : literal(null),
    ]);
  ...
  function compileDeclareClassMetadata(metadata) {
    ...
    return importExpr(Identifiers.declareClassMetadata).callFn([
      definitionMap.toLiteralMap(),
    ]);
  }
  ...
  function compileDeclareDirectiveFromMetadata(meta) {
    ...
    const expression = importExpr(Identifiers.declareDirective).callFn([
      definitionMap.toLiteralMap(),
    ]);
    const type = createDirectiveType(meta);
    return { expression, type, statements: [] };
  ...
  function createDirectiveDefinitionMap(meta) {
    ...
    if (meta.viewQueries.length > 0) {
      definitionMap.set(
        'viewQueries',
        literalArr(meta.viewQueries.map(compileQuery))
      );
    }
    if (meta.exportAs !== null) {
  ...
  function compileHostMetadata(meta) {
    ...
    hostMetadata.set(
      'listeners',
      toOptionalLiteralMap(meta.listeners, literal)
    );
    hostMetadata.set(
      'properties',
      toOptionalLiteralMap(meta.properties, literal)
    );
    if (meta.specialAttributes.styleAttr) {
      hostMetadata.set(
        'styleAttribute',
        literal(meta.specialAttributes.styleAttr)
      );
    }
    if (meta.specialAttributes.classAttr) {
      hostMetadata.set(
        'classAttribute',
        literal(meta.specialAttributes.classAttr)
      );
    }
  ...
  function compileDeclareComponentFromMetadata(
    ...
    const definitionMap = createComponentDefinitionMap(
      meta,
      template,
      additionalTemplateInfo
    );
    const expression = importExpr(Identifiers.declareComponent).callFn([
      definitionMap.toLiteralMap(),
    ]);
    const type = createComponentType(meta);
    return { expression, type, statements: [] };
  ...
  function createComponentDefinitionMap(meta, template, templateInfo) {
    ...
    definitionMap.set(
      'template',
      getTemplateExpression(template, templateInfo)
    );
    ...
    if (meta.changeDetection !== undefined) {
      definitionMap.set(
        'changeDetection',
        importExpr(Identifiers.ChangeDetectionStrategy).prop(
          exports.ChangeDetectionStrategy[meta.changeDetection]
        )
      );
    }
    if (meta.encapsulation !== exports.ViewEncapsulation.Emulated) {
      definitionMap.set(
        'encapsulation',
        importExpr(Identifiers.ViewEncapsulation).prop(
          exports.ViewEncapsulation[meta.encapsulation]
        )
      );
    }
    if (meta.interpolation !== DEFAULT_INTERPOLATION_CONFIG) {
      definitionMap.set(
        'interpolation',
        literalArr([
          literal(meta.interpolation.start),
          literal(meta.interpolation.end),
        ])
      );
    }
    ...
    return toOptionalLiteralArray(meta.declarations, (decl) => {
      switch (decl.kind) {
        case exports.R3TemplateDependencyKind.Directive:
          ...
          dirMeta.set(
            'kind',
            literal(decl.isComponent ? 'component' : 'directive')
          );
          ...
          dirMeta.set(
            'exportAs',
            toOptionalLiteralArray(decl.exportAs, literal)
          );
  ...
  function compileDeclareFactoryFunction(meta) {
    ...
    definitionMap.set(
      'target',
      importExpr(Identifiers.FactoryTarget).prop(
        exports.FactoryTarget[meta.target]
      )
    );
    return {
      expression: importExpr(Identifiers.declareFactory).callFn([
        definitionMap.toLiteralMap(),
      ]),
      statements: [],
      type: createFactoryType(meta),
  ...
  function compileDeclareInjectableFromMetadata(meta) {
    ...
    const expression = importExpr(Identifiers.declareInjectable).callFn([
      definitionMap.toLiteralMap(),
    ]);
  ...
  function createInjectableDefinitionMap(meta) {
    ...
    if (meta.useClass !== undefined) {
      definitionMap.set(
        'useClass',
        convertFromMaybeForwardRefExpression(meta.useClass)
      );
    }
    if (meta.useExisting !== undefined) {
      definitionMap.set(
        'useExisting',
        convertFromMaybeForwardRefExpression(meta.useExisting)
      );
    }
    if (meta.useValue !== undefined) {
      definitionMap.set(
        'useValue',
        convertFromMaybeForwardRefExpression(meta.useValue)
      );
    }
  ...
  function compileDeclareInjectorFromMetadata(meta) {
    ...
    const expression = importExpr(Identifiers.declareInjector).callFn([
      definitionMap.toLiteralMap(),
    ]);
    const type = createInjectorType(meta);
    return { expression, type, statements: [] };
  ...
  function compileDeclareNgModuleFromMetadata(meta) {
    ...
    const expression = importExpr(Identifiers.declareNgModule).callFn([
      definitionMap.toLiteralMap(),
    ]);
    const type = createNgModuleType(meta);
    return { expression, type, statements: [] };
  ...
  function createNgModuleDefinitionMap(meta) {
    ...
    if (meta.bootstrap.length > 0) {
      definitionMap.set(
        'bootstrap',
        refsToArray(meta.bootstrap, meta.containsForwardDecls)
      );
    }
    if (meta.declarations.length > 0) {
      definitionMap.set(
        'declarations',
        refsToArray(meta.declarations, meta.containsForwardDecls)
      );
    }
    if (meta.imports.length > 0) {
      definitionMap.set(
        'imports',
        refsToArray(meta.imports, meta.containsForwardDecls)
      );
    }
    if (meta.exports.length > 0) {
      definitionMap.set(
        'exports',
        refsToArray(meta.exports, meta.containsForwardDecls)
      );
    }
    if (meta.schemas !== null && meta.schemas.length > 0) {
      definitionMap.set(
        'schemas',
        literalArr(meta.schemas.map((ref) => ref.value))
      );
    }
    if (meta.id !== null) {
  ...
  function compileDeclarePipeFromMetadata(meta) {
    ...
    const expression = importExpr(Identifiers.declarePipe).callFn([
      definitionMap.toLiteralMap(),
    ]);
  ...
  exports.compileDeclareComponentFromMetadata =
    compileDeclareComponentFromMetadata;
  exports.compileDeclareDirectiveFromMetadata =
    compileDeclareDirectiveFromMetadata;
  exports.compileDeclareFactoryFunction = compileDeclareFactoryFunction;
  exports.compileDeclareInjectableFromMetadata =
    compileDeclareInjectableFromMetadata;
  exports.compileDeclareInjectorFromMetadata =
    compileDeclareInjectorFromMetadata;
  exports.compileDeclareNgModuleFromMetadata =
