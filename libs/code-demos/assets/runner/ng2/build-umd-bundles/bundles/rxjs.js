(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.rxjs = {}, global.tslib));
    ...
    var animationFrameProvider = {
        ...
        requestAnimationFrame: function () {
            ...
            return ((delegate === null || delegate === void 0 ? void 0 : delegate.requestAnimationFrame) || requestAnimationFrame).apply(void 0, tslib.__spreadArray([], tslib.__read(args)));
        },
        cancelAnimationFrame: function () {
            ...
            return (cancelAnimationFrame).apply(void 0, tslib.__spreadArray([], tslib.__read(args)));
        },
        delegate: undefined,
    };
    ...
    var immediateProvider = {
        setImmediate: function () {
            ...
            return ((delegate === null || delegate === void 0 ? void 0 : delegate.setImmediate) || setImmediate).apply(void 0, tslib.__spreadArray([], tslib.__read(args)));
        },
        clearImmediate: function (handle) {
    ...
    var VirtualTimeScheduler = (function (_super) {
        tslib.__extends(VirtualTimeScheduler, _super);
    ...
    var VirtualAction = (function (_super) {
        tslib.__extends(VirtualAction, _super);
    ...
    function callOrApply(fn, args) {
        return isArray$2(args) ? fn.apply(void 0, tslib.__spreadArray([], tslib.__read(args))) : fn(args);
    }
        ...
        return function () {
            ...
            return new Observable(function (subscriber) {
                ...
                if (uninitialized) {
                    ...
                    callbackFunc.apply(_this, tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(args)), [
                        function () {
                            var results = [];
                            for (var _i = 0; _i < arguments.length; _i++) {
    ...
    function fromEvent(target, eventName, options, resultSelector) {
        ...
        var _a = tslib.__read(isEventTarget(target)
    ...
    function concatWith() {
        ...
        return concat.apply(void 0, tslib.__spreadArray([], tslib.__read(otherSources)));
    }
    ...
    function endWith() {
        ...
        return function (source) { return concat$1(source, of.apply(void 0, tslib.__spreadArray([], tslib.__read(values)))); };
    }
