(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    ? define(['exports', '@angular/common', '@angular/core'], factory)
    : ((global =
        typeof globalThis !== 'undefined' ? globalThis : global || self),
      factory((global.ngPlatformBrowser = {}), global.ngCommon, global.ng));
    ...
    return () => {
      ...
      injector.get(i0.ApplicationInitStatus).donePromise.then(() => {
        ...
        const styles = document.querySelectorAll(
          `style[ng-transition="${transitionId}"]`
        );
  ...
  class BrowserGetTestability {
    addToWindow(registry) {
      i0['ɵglobal']['getAngularTestability'] = (
        elem,
      ...
      i0['ɵglobal']['getAllAngularTestabilities'] = () =>
        registry.getAllTestabilities();
      i0['ɵglobal']['getAllAngularRootElements'] = () =>
  ...
  BrowserXhr.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
  ...
  BrowserXhr.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: BrowserXhr,
  ...
  EventManager.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: EventManager,
    deps: [{ token: EVENT_MANAGER_PLUGINS }, { token: i0__namespace.NgZone }],
    target: i0__namespace.ɵɵFactoryTarget.Injectable,
  });
  EventManager.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: EventManager,
  ...
  class EventManagerPlugin {
    ...
    addGlobalEventListener(element, eventName, handler) {
      const target = common['ɵgetDOM']().getGlobalEventTarget(
        this._doc,
        element
      );
      if (!target) {
  ...
  SharedStylesHost.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
  ...
  SharedStylesHost.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: SharedStylesHost,
  ...
  DomSharedStylesHost.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: DomSharedStylesHost,
    deps: [{ token: common.DOCUMENT }],
    target: i0__namespace.ɵɵFactoryTarget.Injectable,
  });
  DomSharedStylesHost.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: DomSharedStylesHost,
  ...
  DomRendererFactory2.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
  ...
  DomRendererFactory2.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: DomRendererFactory2,
  ...
  class DefaultDomRenderer2 {
    ...
    setStyle(el, style, value, flags) {
      if (
        flags &
        (i0.RendererStyleFlags2.DashCase | i0.RendererStyleFlags2.Important)
      ) {
        el.style.setProperty(
          style,
          value,
          flags & i0.RendererStyleFlags2.Important ? 'important' : ''
        );
      } else {
  ...
  DomEventsPlugin.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
  ...
  DomEventsPlugin.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: DomEventsPlugin,
  ...
  class KeyEventsPlugin extends EventManagerPlugin {
    ...
    addEventListener(element, eventName, handler) {
      ...
      return this.manager.getZone().runOutsideAngular(() => {
        return common['ɵgetDOM']().onAndCancel(
          element,
  ...
  KeyEventsPlugin.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
  ...
  KeyEventsPlugin.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: KeyEventsPlugin,
  ...
  function bootstrapApplication(rootComponent, options) {
    return i0['ɵinternalCreateApplication'](
      Object.assign({ rootComponent }, createProvidersConfig(options))
    );
  }
  /**
      ...
      appProviders: [
        ...
        ...((_a =
          options === null || options === void 0
            ? void 0
            : options.providers) !== null && _a !== void 0
          ? _a
          : []),
      ],
   ...
   * @publicApi
   */
  const platformBrowser = i0.createPlatformFactory(
    i0.platformCore,
    'browser',
   ...
   */
  const BROWSER_MODULE_PROVIDERS_MARKER = new i0.InjectionToken(
    NG_DEV_MODE ? 'BrowserModule Providers Marker' : ''
  );
  ...
  const BROWSER_MODULE_PROVIDERS = [
    ...
    },
    {
      ...
      deps: [EVENT_MANAGER_PLUGINS, i0.NgZone],
    },
  ...
  BrowserModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: BrowserModule,
  ...
  BrowserModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({
    minVersion: '14.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: BrowserModule,
  ...
  BrowserModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: BrowserModule,
  ...
  Meta.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: Meta,
  ...
  Meta.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: Meta,
  ...
  Title.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: Title,
  ...
  Title.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: Title,
  ...
  TransferState.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: TransferState,
  ...
  TransferState.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: TransferState,
  ...
  BrowserTransferStateModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
  ...
  BrowserTransferStateModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({
    minVersion: '14.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: BrowserTransferStateModule,
  });
  BrowserTransferStateModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: BrowserTransferStateModule,
  ...
  HammerGestureConfig.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
  ...
  HammerGestureConfig.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: HammerGestureConfig,
  ...
  HammerGesturesPlugin.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: HammerGesturesPlugin,
    deps: [
      { token: common.DOCUMENT },
      { token: HAMMER_GESTURE_CONFIG },
      { token: i0__namespace.ɵConsole },
      { token: HAMMER_LOADER, optional: true },
    ],
    target: i0__namespace.ɵɵFactoryTarget.Injectable,
  });
  HammerGesturesPlugin.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: HammerGesturesPlugin,
   ...
   */
  class HammerModule {}
  HammerModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: HammerModule,
  ...
  HammerModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({
    minVersion: '14.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: HammerModule,
  });
  HammerModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: HammerModule,
   ...
   */
  class DomSanitizer {}
  DomSanitizer.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: DomSanitizer,
  ...
  DomSanitizer.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: DomSanitizer,
    providedIn: 'root',
    useExisting: i0__namespace.forwardRef(function () {
    ...
    sanitize(ctx, value) {
      ...
      switch (ctx) {
        ...
        case i0.SecurityContext.HTML:
          if (
            i0['ɵallowSanitizationBypassAndThrow'](
              value,
              'HTML' /* BypassType.Html */
            )
          ) {
        ...
        default:
          throw new Error(
            `Unexpected SecurityContext ${ctx} (see https://g.co/ng/security#xss)`
          );
      }
    }
  ...
  DomSanitizerImpl.ɵfac = i0__namespace.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
  ...
  DomSanitizerImpl.ɵprov = i0__namespace.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.7',
    ngImport: i0__namespace,
    type: DomSanitizerImpl,
  ...
  exports['ɵINTERNAL_BROWSER_PLATFORM_PROVIDERS'] =
    INTERNAL_BROWSER_PLATFORM_PROVIDERS;
