 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function eventTargetLegacyPatch(e,t){const{eventNames:n,globalSources:r,zoneSymbolEventNames:o,TRUE_STR:a,FALSE_STR:c,ZONE_SYMBOL_PREFIX:i}=t.getGlobalObjects(),s="ApplicationCache,EventSource,FileReader,InputMethodContext,MediaController,MessagePort,Node,Performance,SVGElementInstance,SharedWorker,TextTrack,TextTrackCue,TextTrackList,WebKitNamedFlow,Window,Worker,WorkerGlobalScope,XMLHttpRequest,XMLHttpRequestEventTarget,XMLHttpRequestUpload,IDBRequest,IDBOpenDBRequest,IDBDatabase,IDBTransaction,IDBCursor,DBIndex,WebSocket".split(",");let l=[];const p=e.wtf,u="Anchor,Area,Audio,BR,Base,BaseFont,Body,Button,Canvas,Content,DList,Directory,Div,Embed,FieldSet,Font,Form,Frame,FrameSet,HR,Head,Heading,Html,IFrame,Image,Input,Keygen,LI,Label,Legend,Link,Map,Marquee,Media,Menu,Meta,Meter,Mod,OList,Object,OptGroup,Option,Output,Paragraph,Pre,Progress,Quote,Script,Select,Source,Span,Style,TableCaption,TableCell,TableCol,Table,TableRow,TableSection,TextArea,Title,Track,UList,Unknown,Video".split(",");p?l=u.map((e=>"HTML"+e+"Element")).concat(s):e.EventTarget?l.push("EventTarget"):l=s;const d=e.__Zone_disable_IE_check||!1,g=e.__Zone_enable_cross_context_check||!1,m=t.isIEOrEdge(),f="[object FunctionWrapper]",b="function __BROWSERTOOLS_CONSOLE_SAFEFUNC() { [native code] }",y={MSPointerCancel:"pointercancel",MSPointerDown:"pointerdown",MSPointerEnter:"pointerenter",MSPointerHover:"pointerhover",MSPointerLeave:"pointerleave",MSPointerMove:"pointermove",MSPointerOut:"pointerout",MSPointerOver:"pointerover",MSPointerUp:"pointerup"};for(let e=0;e<n.length;e++){const t=n[e],r=i+(t+c),s=i+(t+a);o[t]={},o[t][c]=r,o[t][a]=s}for(let e=0;e<u.length;e++){const t=u[e],o=r[t]={};for(let e=0;e<n.length;e++){const r=n[e];o[r]=t+".addEventListener:"+r}}const h=[];for(let t=0;t<l.length;t++){const n=e[l[t]];h.push(n&&n.prototype)}return t.patchEventTarget(e,t,h,{vh:function(e,t,n,r){if(!d&&m)if(g)try{const o=t.toString();if(o===f||o==b)return e.apply(n,r),!1}catch(t){return e.apply(n,r),!1}else{const o=t.toString();if(o===f||o==b)return e.apply(n,r),!1}else if(g)try{t.toString()}catch(t){return e.apply(n,r),!1}return!0},transferEventName:e=>y[e]||e}),Zone[t.symbol("patchEventTarget")]=!!e.EventTarget,!0}
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
