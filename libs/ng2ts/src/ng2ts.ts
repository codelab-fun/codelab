...
import { DiffFilesResolver } from '../src/modules/differ/diffFilesResolver';
...
const preloadedFiles = {
  ...
  'app.module.ts': require('!raw-loader!./modules.module.ts'),
  'app.html': require('!raw-loader!./modules.html'),
  ...
  'thumbs.app.module.ts': require('!raw-loader!./thumbs.modules.module.ts'),
  'video.app.module.ts': require('!raw-loader!./video.modules.module.ts'),
  'toggle-panel.app.module.ts': require('!raw-loader!./toggle-panel.modules.module.ts'),
  'index.html': '<base href="/assets/runner/"><my-modules></my-modules>'
...
export const ng2tsConfig: /*TODO: fix the type to be: CodelabConfigTemplate */any = {
  ...
  milestones: [
    ...
    {
      name: 'Bootstrapping your modules',
      exercises: [
        {
          name: 'Intro',
          slide: true
