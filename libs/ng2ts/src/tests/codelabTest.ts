 ...
 *
 * the configuration is in modules/codelab/codelab-config.ts.
 *
 *
 * There are
 *
...
describe('Component', () => {
  ...
  /*
   xit(`Let's debug the modules! You'll need this if something goes wrong.
   * Open the dev tools in your browser
   * Put in the new method add 'debugger;'
   * The modules will stop, and you'll be able to inspect local variables.
   * Get out using F8
