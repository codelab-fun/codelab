...
import { ModeOverviewComponent } from '@mycurrentapp/presentation/src/mode-overview/mode-overview.component';
import { ModeRoutingDirective } from '@mycurrentapp/presentation/src/mode-routing/mode-routing.directive';
